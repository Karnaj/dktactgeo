...
Definition lemma__ABCequalsCBA : forall A B C, (euclidean__axioms.nCol A B C) -> (euclidean__defs.CongA A B C C B A).
Proof.
intro A.
intro B.
intro C.
...
-- assert (* Cut *) (exists E, (euclidean__axioms.BetS B A E) /\ (euclidean__axioms.Cong A E C B)) as H2.
...
----- assert (* Cut *) (exists F, (euclidean__axioms.BetS B C F) /\ (euclidean__axioms.Cong C F A B)) as H8.
