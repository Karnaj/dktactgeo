...
Definition lemma__oppositesidesymmetric : forall A B P Q, (euclidean__axioms.TS P A B Q) -> (euclidean__axioms.TS Q A B P).
Proof.
intro A.
intro B.
intro P.
...
------------ assert ((R = B) \/ (euclidean__axioms.neq R B)) as H17 by exact H16.
assert ((R = B) \/ (euclidean__axioms.neq R B)) as __TmpHyp by exact H17.
destruct __TmpHyp as [H18|H18].
------------- assert (* Cut *) (euclidean__axioms.Col P B Q) as H19.
-------------- apply (@eq__ind__r euclidean__axioms.Point B (fun R0 => (euclidean__axioms.BetS P R0 Q) -> ((euclidean__axioms.Col A B R0) -> ((euclidean__axioms.BetS Q R0 P) -> ((euclidean__axioms.Col P R0 Q) -> ((euclidean__axioms.Col B Q R0) -> ((euclidean__axioms.Col Q R0 B) -> ((euclidean__axioms.Col Q R0 P) -> ((euclidean__axioms.neq Q R0) -> ((euclidean__axioms.Col R0 B P) -> ((euclidean__axioms.Col R0 B A) -> (euclidean__axioms.Col P B Q)))))))))))) with (x := R).
---------------intro H19.
intro H20.
intro H21.
intro H22.
...
------------------ apply (@eq__ind__r euclidean__axioms.Point B (fun R0 => (euclidean__axioms.BetS P R0 Q) -> ((euclidean__axioms.Col A B R0) -> ((euclidean__axioms.BetS Q R0 P) -> ((euclidean__axioms.Col P R0 Q) -> ((euclidean__axioms.Col B Q R0) -> ((euclidean__axioms.Col Q R0 B) -> ((euclidean__axioms.Col Q R0 P) -> ((euclidean__axioms.neq Q R0) -> ((euclidean__axioms.Col R0 B P) -> ((euclidean__axioms.Col R0 B A) -> ((euclidean__axioms.neq R0 Q) -> (euclidean__axioms.neq B Q))))))))))))) with (x := R).
-------------------intro H23.
intro H24.
intro H25.
intro H26.
