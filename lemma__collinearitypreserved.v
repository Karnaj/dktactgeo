...
Definition lemma__collinearitypreserved : forall A B C a b c, (euclidean__axioms.Col A B C) -> ((euclidean__axioms.Cong A B a b) -> ((euclidean__axioms.Cong A C a c) -> ((euclidean__axioms.Cong B C b c) -> (euclidean__axioms.Col a b c)))).
Proof.
intro A.
intro B.
intro C.
...
--------- assert ((A = B) \/ ((A = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))))) as H12 by exact H.
assert (* Cut *) (euclidean__axioms.Col a b c) as H13.
---------- assert ((A = B) \/ ((A = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))))) as H13 by exact H12.
assert ((A = B) \/ ((A = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))))) as __TmpHyp by exact H13.
destruct __TmpHyp as [H14|H14].
----------- assert (* Cut *) (euclidean__axioms.Cong A A a b) as H15.
------------ apply (@eq__ind__r euclidean__axioms.Point B (fun A0 => (euclidean__axioms.Col A0 B C) -> ((euclidean__axioms.Cong A0 B a b) -> ((euclidean__axioms.Cong A0 C a c) -> ((euclidean__axioms.Cong A0 B b a) -> ((euclidean__axioms.Cong A0 B B A0) -> ((euclidean__axioms.Cong B A0 A0 B) -> ((euclidean__axioms.Cong B A0 b a) -> (euclidean__axioms.Cong A0 A0 a b))))))))) with (x := A).
-------------intro H15.
intro H16.
intro H17.
intro H18.
...
------------- apply (@eq__ind__r euclidean__axioms.Point C (fun A0 => (euclidean__axioms.Col A0 B C) -> ((euclidean__axioms.Cong A0 B a b) -> ((euclidean__axioms.Cong A0 C a c) -> ((euclidean__axioms.Cong A0 B b a) -> ((euclidean__axioms.Cong A0 B B A0) -> ((euclidean__axioms.Cong B A0 A0 B) -> ((euclidean__axioms.Cong B A0 b a) -> (euclidean__axioms.Cong A0 A0 a c))))))))) with (x := A).
--------------intro H16.
intro H17.
intro H18.
intro H19.
...
------------------- apply (@logic.eq__refl Point A).
------------------- apply (@H19 H20).
------------------ assert (False) as H21 by exact H20.
apply (@logic.eq__refl Point A).
----------------- apply (@H19 H20).
...
-------------- apply (@eq__ind__r euclidean__axioms.Point C (fun B0 => (euclidean__axioms.Col A B0 C) -> ((euclidean__axioms.Cong A B0 a b) -> ((euclidean__axioms.Cong B0 C b c) -> ((euclidean__axioms.Cong C B0 B0 C) -> ((euclidean__axioms.Cong C B0 b c) -> ((euclidean__axioms.Cong C B0 c b) -> ((euclidean__axioms.Cong A B0 b a) -> ((euclidean__axioms.Cong A B0 B0 A) -> ((euclidean__axioms.Cong B0 A A B0) -> ((euclidean__axioms.Cong B0 A b a) -> (euclidean__axioms.Cong B0 B0 b c)))))))))))) with (x := B).
---------------intro H17.
intro H18.
intro H19.
intro H20.
...
-------------------- apply (@H20 H21).
------------------- assert (False) as H22 by exact H21.
apply (@logic.eq__refl Point B).
------------------ apply (@H20 H21).
