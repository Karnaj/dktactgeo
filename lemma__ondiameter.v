...
Definition lemma__ondiameter : forall (D: euclidean__axioms.Point) (F: euclidean__axioms.Point) (K: euclidean__axioms.Circle) (M: euclidean__axioms.Point) (N: euclidean__axioms.Point) (P: euclidean__axioms.Point) (Q: euclidean__axioms.Point), (euclidean__axioms.CI K F P Q) -> ((euclidean__axioms.Cong F D P Q) -> ((euclidean__axioms.Cong F M P Q) -> ((euclidean__axioms.BetS D F M) -> ((euclidean__axioms.BetS D N M) -> (euclidean__axioms.InCirc N K))))).
Proof.
intro D.
intro F.
intro K.
...
-- assert (* AndElim *) ((euclidean__axioms.neq F M) /\ ((euclidean__axioms.neq D F) /\ (euclidean__axioms.neq D M))) as H5.
--- exact H4.
--- destruct H5 as [H5 H6].
assert (* AndElim *) ((euclidean__axioms.neq D F) /\ (euclidean__axioms.neq D M)) as H7.
---- exact H6.
...
------ assert (* Cut *) ((euclidean__axioms.BetS D N F) \/ ((euclidean__axioms.BetS F N M) \/ (F = N))) as H9.
------- exact H8.
------- assert (* Cut *) ((euclidean__axioms.BetS D N F) \/ ((euclidean__axioms.BetS F N M) \/ (F = N))) as __TmpHyp.
-------- exact H9.
-------- assert (euclidean__axioms.BetS D N F \/ (euclidean__axioms.BetS F N M) \/ (F = N)) as H10.
--------- exact __TmpHyp.
...
---------------- exact H7.
------------ exact H12.
---------- assert (euclidean__axioms.BetS F N M \/ F = N) as H11.
----------- exact H10.
