...
Definition lemma__trichotomy1 : forall A B C D, (~(euclidean__defs.Lt A B C D)) -> ((~(euclidean__defs.Lt C D A B)) -> ((euclidean__axioms.neq A B) -> ((euclidean__axioms.neq C D) -> (euclidean__axioms.Cong A B C D)))).
Proof.
intro A.
intro B.
intro C.
...
- assert (* Cut *) (exists P, (euclidean__axioms.BetS B A P) /\ (euclidean__axioms.Cong A P A B)) as H4.
...
----- assert (* Cut *) (exists E, (euclidean__axioms.BetS P A E) /\ (euclidean__axioms.Cong A E C D)) as H11.
...
----------- apply (@eq__ind__r euclidean__axioms.Point B (fun E0 => (euclidean__axioms.BetS P A E0) -> ((euclidean__axioms.Cong A E0 C D) -> ((~(euclidean__axioms.BetS A B E0)) -> ((~(euclidean__axioms.BetS A E0 B)) -> (euclidean__axioms.Cong A B A E0)))))) with (x := E).
------------intro H19.
intro H20.
intro H21.
intro H22.
...
------------ apply (@eq__ind__r euclidean__axioms.Point B (fun E0 => (euclidean__axioms.BetS P A E0) -> ((euclidean__axioms.Cong A E0 C D) -> ((~(euclidean__axioms.BetS A B E0)) -> ((~(euclidean__axioms.BetS A E0 B)) -> ((euclidean__axioms.Cong A B A E0) -> (euclidean__axioms.Cong A B C D))))))) with (x := E).
-------------intro H20.
intro H21.
intro H22.
intro H23.
