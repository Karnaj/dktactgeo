...
Definition lemma__fiveline : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (D: euclidean__axioms.Point) (a: euclidean__axioms.Point) (b: euclidean__axioms.Point) (c: euclidean__axioms.Point) (d: euclidean__axioms.Point), (euclidean__axioms.Col A B C) -> ((euclidean__axioms.Cong A B a b) -> ((euclidean__axioms.Cong B C b c) -> ((euclidean__axioms.Cong A D a d) -> ((euclidean__axioms.Cong C D c d) -> ((euclidean__axioms.Cong A C a c) -> ((euclidean__axioms.neq A C) -> (euclidean__axioms.Cong B D b d))))))).
Proof.
intro A.
intro B.
intro C.
...
----intro H7.
assert (A = B \/ (A = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B))))) as H8.
----- exact H6.
...
----------------exact H11.
---------------- contradiction.
------ assert (A = C \/ (B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))) as H9.
------- exact H8.
...
------------------exact H10.
------------------ contradiction.
-------- assert (B = C \/ (euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B))) as H10.
--------- exact H9.
...
--------------------exact H15.
-------------------- contradiction.
---------- assert (euclidean__axioms.BetS B A C \/ (euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)) as H11.
----------- exact H10.
...
----------------------exact H18.
---------------------- contradiction.
------------ assert (euclidean__axioms.BetS A B C \/ euclidean__axioms.BetS A C B) as H12.
------------- exact H11.
...
--- assert (* Cut *) ((A = B) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B))))) as H8.
---- exact H7.
---- assert (* Cut *) ((A = B) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B))))) as __TmpHyp.
----- exact H8.
----- assert (A = B \/ (B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))) as H9.
------ exact __TmpHyp.
------ destruct H9 as [H9|H9].
------- assert (* Cut *) (euclidean__axioms.Cong B B a b) as H10.
-------- apply (@eq__ind__r euclidean__axioms.Point B (fun A0: euclidean__axioms.Point => (euclidean__axioms.Col A0 B C) -> ((euclidean__axioms.Cong A0 B a b) -> ((euclidean__axioms.Cong A0 D a d) -> ((euclidean__axioms.Cong A0 C a c) -> ((euclidean__axioms.neq A0 C) -> (((A0 = B) \/ ((A0 = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A0 C) \/ ((euclidean__axioms.BetS A0 B C) \/ (euclidean__axioms.BetS A0 C B)))))) -> (euclidean__axioms.Cong B B a b)))))))) with (x := A).
---------intro H10.
intro H11.
intro H12.
intro H13.
...
------------ apply (@eq__ind euclidean__axioms.Point a (fun X: euclidean__axioms.Point => euclidean__axioms.Cong B D X d)) with (y := b).
------------- exact H13.
...
---------- apply (@eq__ind__r euclidean__axioms.Point C (fun B0: euclidean__axioms.Point => (euclidean__axioms.Col A B0 C) -> ((euclidean__axioms.Cong A B0 a b) -> ((euclidean__axioms.Cong B0 C b c) -> (((A = B0) \/ ((A = C) \/ ((B0 = C) \/ ((euclidean__axioms.BetS B0 A C) \/ ((euclidean__axioms.BetS A B0 C) \/ (euclidean__axioms.BetS A C B0)))))) -> (euclidean__axioms.Cong B0 B0 b c)))))) with (x := B).
-----------intro H11.
intro H12.
intro H13.
intro H14.
...
-------------- apply (@eq__ind__r euclidean__axioms.Point c (fun X: euclidean__axioms.Point => euclidean__axioms.Cong B D X d)) with (x := b).
--------------- exact H14.
...
-------------- assert (* AndElim *) ((euclidean__axioms.Cong C A c a) /\ ((euclidean__axioms.Cong C A a c) /\ (euclidean__axioms.Cong A C c a))) as H14.
--------------- exact H13.
--------------- destruct H14 as [H14 H15].
assert (* AndElim *) ((euclidean__axioms.Cong C A a c) /\ (euclidean__axioms.Cong A C c a)) as H16.
---------------- exact H15.
...
--------------- assert (* AndElim *) ((euclidean__axioms.Cong C B c b) /\ ((euclidean__axioms.Cong C B b c) /\ (euclidean__axioms.Cong B C c b))) as H15.
---------------- exact H14.
---------------- destruct H15 as [H15 H16].
assert (* AndElim *) ((euclidean__axioms.Cong C B b c) /\ (euclidean__axioms.Cong B C c b)) as H17.
----------------- exact H16.
...
------------------ assert (* AndElim *) ((euclidean__axioms.Cong B D b d) /\ ((euclidean__axioms.Cong B D d b) /\ (euclidean__axioms.Cong D B b d))) as H18.
------------------- exact H17.
------------------- destruct H18 as [H18 H19].
assert (* AndElim *) ((euclidean__axioms.Cong B D d b) /\ (euclidean__axioms.Cong D B b d)) as H20.
-------------------- exact H19.
...
--------------- apply (@lemma__congruenceflip.lemma__congruenceflip (B) (C) (b) (c) H1).
--------------- assert (* AndElim *) ((euclidean__axioms.Cong C B c b) /\ ((euclidean__axioms.Cong C B b c) /\ (euclidean__axioms.Cong B C c b))) as H14.
---------------- exact H13.
---------------- destruct H14 as [H14 H15].
assert (* AndElim *) ((euclidean__axioms.Cong C B b c) /\ (euclidean__axioms.Cong B C c b)) as H16.
----------------- exact H15.
----------------- destruct H16 as [H16 H17].
exact H14.
...
------------------ assert (* AndElim *) ((euclidean__axioms.Cong B D b d) /\ ((euclidean__axioms.Cong B D d b) /\ (euclidean__axioms.Cong D B b d))) as H17.
------------------- exact H16.
------------------- destruct H17 as [H17 H18].
assert (* AndElim *) ((euclidean__axioms.Cong B D d b) /\ (euclidean__axioms.Cong D B b d)) as H19.
-------------------- exact H18.
