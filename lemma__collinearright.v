...
Definition lemma__collinearright : forall A B C D, (euclidean__defs.Per A B D) -> ((euclidean__axioms.Col A B C) -> ((euclidean__axioms.neq C B) -> (euclidean__defs.Per C B D))).
Proof.
intro A.
intro B.
intro C.
...
intro H0.
intro H1.
assert ((A = B) \/ ((A = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))))) as H2 by exact H0.
...
--- apply (@eq__ind__r euclidean__axioms.Point B (fun A0 => (euclidean__defs.Per A0 B D) -> ((euclidean__axioms.Col A0 B C) -> (((A0 = B) \/ ((A0 = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A0 C) \/ ((euclidean__axioms.BetS A0 B C) \/ (euclidean__axioms.BetS A0 C B)))))) -> ((euclidean__axioms.nCol A0 B D) -> (euclidean__axioms.nCol A0 A0 D)))))) with (x := A).
----intro H5.
intro H6.
intro H7.
intro H8.
...
---- assert ((A = B) \/ ((A = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))))) as H6 by exact H2.
assert ((A = B) \/ ((A = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))))) as __TmpHyp by exact H6.
destruct __TmpHyp as [H7|H7].
...
------- apply (@eq__ind__r euclidean__axioms.Point C (fun A0 => (euclidean__defs.Per A0 B D) -> ((euclidean__axioms.Col A0 B C) -> ((euclidean__axioms.nCol A0 B D) -> ((~(A0 = B)) -> ((euclidean__defs.Per D B A0) -> (euclidean__defs.Per D B C))))))) with (x := A).
--------intro H9.
intro H10.
intro H11.
intro H12.
...
--------- assert (exists E, (euclidean__axioms.BetS A B E) /\ ((euclidean__axioms.Cong A B E B) /\ ((euclidean__axioms.Cong A D E D) /\ (euclidean__axioms.neq B D)))) as H12 by exact H.
...
-------------- assert (euclidean__axioms.BetS A B E) as H25 by exact H14.
...
-------------- exact H14.
------------- assert (euclidean__defs.Per D B A) as H16 by exact H5.
