...
Definition lemma__droppedperpendicularunique : forall (A: euclidean__axioms.Point) (J: euclidean__axioms.Point) (M: euclidean__axioms.Point) (P: euclidean__axioms.Point), (euclidean__defs.Per A M P) -> ((euclidean__defs.Per A J P) -> ((euclidean__axioms.Col A M J) -> (M = J))).
Proof.
intro A.
intro J.
intro M.
...
-- assert (* Cut *) (exists (E: euclidean__axioms.Point), (euclidean__axioms.BetS M J E) /\ (euclidean__axioms.Cong J E M J)) as H4.
--- apply (@lemma__extension.lemma__extension (M) (J) (M) (J) (H2) H2).
--- assert (exists E: euclidean__axioms.Point, ((euclidean__axioms.BetS M J E) /\ (euclidean__axioms.Cong J E M J))) as H5.
---- exact H4.
---- destruct H5 as [E H5].
assert (* AndElim *) ((euclidean__axioms.BetS M J E) /\ (euclidean__axioms.Cong J E M J)) as H6.
----- exact H5.
...
------- assert (* AndElim *) ((euclidean__axioms.neq J E) /\ ((euclidean__axioms.neq M J) /\ (euclidean__axioms.neq M E))) as H9.
-------- exact H8.
-------- destruct H9 as [H9 H10].
assert (* AndElim *) ((euclidean__axioms.neq M J) /\ (euclidean__axioms.neq M E)) as H11.
--------- exact H10.
--------- destruct H11 as [H11 H12].
exact H12.
------ assert (* Cut *) (exists (F: euclidean__axioms.Point), (euclidean__axioms.BetS J M F) /\ (euclidean__axioms.Cong M F M E)) as H9.
------- apply (@lemma__extension.lemma__extension (J) (M) (M) (E) (H3) H8).
------- assert (exists F: euclidean__axioms.Point, ((euclidean__axioms.BetS J M F) /\ (euclidean__axioms.Cong M F M E))) as H10.
-------- exact H9.
-------- destruct H10 as [F H10].
assert (* AndElim *) ((euclidean__axioms.BetS J M F) /\ (euclidean__axioms.Cong M F M E)) as H11.
--------- exact H10.
--------- destruct H11 as [H11 H12].
...
--------------- assert (* AndElim *) ((euclidean__axioms.neq J F) /\ ((euclidean__axioms.neq E J) /\ (euclidean__axioms.neq E F))) as H18.
---------------- exact H17.
---------------- destruct H18 as [H18 H19].
assert (* AndElim *) ((euclidean__axioms.neq E J) /\ (euclidean__axioms.neq E F)) as H20.
----------------- exact H19.
...
------------------ assert (* AndElim *) ((euclidean__axioms.Col M J F) /\ ((euclidean__axioms.Col M F J) /\ ((euclidean__axioms.Col F J M) /\ ((euclidean__axioms.Col J F M) /\ (euclidean__axioms.Col F M J))))) as H21.
------------------- exact H20.
------------------- destruct H21 as [H21 H22].
assert (* AndElim *) ((euclidean__axioms.Col M F J) /\ ((euclidean__axioms.Col F J M) /\ ((euclidean__axioms.Col J F M) /\ (euclidean__axioms.Col F M J)))) as H23.
-------------------- exact H22.
-------------------- destruct H23 as [H23 H24].
assert (* AndElim *) ((euclidean__axioms.Col F J M) /\ ((euclidean__axioms.Col J F M) /\ (euclidean__axioms.Col F M J))) as H25.
--------------------- exact H24.
--------------------- destruct H25 as [H25 H26].
assert (* AndElim *) ((euclidean__axioms.Col J F M) /\ (euclidean__axioms.Col F M J)) as H27.
---------------------- exact H26.
...
------------------- assert (* AndElim *) ((euclidean__axioms.Col M A J) /\ ((euclidean__axioms.Col M J A) /\ ((euclidean__axioms.Col J A M) /\ ((euclidean__axioms.Col A J M) /\ (euclidean__axioms.Col J M A))))) as H22.
-------------------- exact H21.
-------------------- destruct H22 as [H22 H23].
assert (* AndElim *) ((euclidean__axioms.Col M J A) /\ ((euclidean__axioms.Col J A M) /\ ((euclidean__axioms.Col A J M) /\ (euclidean__axioms.Col J M A)))) as H24.
--------------------- exact H23.
--------------------- destruct H24 as [H24 H25].
assert (* AndElim *) ((euclidean__axioms.Col J A M) /\ ((euclidean__axioms.Col A J M) /\ (euclidean__axioms.Col J M A))) as H26.
---------------------- exact H25.
---------------------- destruct H26 as [H26 H27].
assert (* AndElim *) ((euclidean__axioms.Col A J M) /\ (euclidean__axioms.Col J M A)) as H28.
----------------------- exact H27.
...
-------------------- assert (* AndElim *) ((euclidean__axioms.neq M F) /\ ((euclidean__axioms.neq E M) /\ (euclidean__axioms.neq E F))) as H23.
--------------------- exact H22.
--------------------- destruct H23 as [H23 H24].
assert (* AndElim *) ((euclidean__axioms.neq E M) /\ (euclidean__axioms.neq E F)) as H25.
---------------------- exact H24.
---------------------- destruct H25 as [H25 H26].
exact H3.
------------------- assert (* Cut *) (euclidean__axioms.neq M J) as H23.
-------------------- exact H2.
...
----------------------- assert (* AndElim *) ((euclidean__axioms.Col F J A) /\ ((euclidean__axioms.Col F A J) /\ ((euclidean__axioms.Col A J F) /\ ((euclidean__axioms.Col J A F) /\ (euclidean__axioms.Col A F J))))) as H26.
------------------------ exact H25.
------------------------ destruct H26 as [H26 H27].
assert (* AndElim *) ((euclidean__axioms.Col F A J) /\ ((euclidean__axioms.Col A J F) /\ ((euclidean__axioms.Col J A F) /\ (euclidean__axioms.Col A F J)))) as H28.
------------------------- exact H27.
------------------------- destruct H28 as [H28 H29].
assert (* AndElim *) ((euclidean__axioms.Col A J F) /\ ((euclidean__axioms.Col J A F) /\ (euclidean__axioms.Col A F J))) as H30.
-------------------------- exact H29.
-------------------------- destruct H30 as [H30 H31].
assert (* AndElim *) ((euclidean__axioms.Col J A F) /\ (euclidean__axioms.Col A F J)) as H32.
--------------------------- exact H31.
--------------------------- destruct H32 as [H32 H33].
exact H30.
---------------------- assert (* Cut *) (euclidean__defs.Per F J P) as H26.
----------------------- apply (@lemma__collinearright.lemma__collinearright (A) (J) (F) (P) (H0) (H25) H18).
----------------------- assert (* Cut *) (euclidean__axioms.Col J M F) as H27.
------------------------ exact H19.
...
-------------------------- assert (* AndElim *) ((euclidean__axioms.Col J M A) /\ ((euclidean__axioms.Col J A M) /\ ((euclidean__axioms.Col A M J) /\ ((euclidean__axioms.Col M A J) /\ (euclidean__axioms.Col A J M))))) as H29.
--------------------------- exact H28.
--------------------------- destruct H29 as [H29 H30].
assert (* AndElim *) ((euclidean__axioms.Col J A M) /\ ((euclidean__axioms.Col A M J) /\ ((euclidean__axioms.Col M A J) /\ (euclidean__axioms.Col A J M)))) as H31.
---------------------------- exact H30.
---------------------------- destruct H31 as [H31 H32].
assert (* AndElim *) ((euclidean__axioms.Col A M J) /\ ((euclidean__axioms.Col M A J) /\ (euclidean__axioms.Col A J M))) as H33.
----------------------------- exact H32.
----------------------------- destruct H33 as [H33 H34].
assert (* AndElim *) ((euclidean__axioms.Col M A J) /\ (euclidean__axioms.Col A J M)) as H35.
------------------------------ exact H34.
...
---------------------------- assert (* AndElim *) ((euclidean__axioms.Col F M A) /\ ((euclidean__axioms.Col F A M) /\ ((euclidean__axioms.Col A M F) /\ ((euclidean__axioms.Col M A F) /\ (euclidean__axioms.Col A F M))))) as H31.
----------------------------- exact H30.
----------------------------- destruct H31 as [H31 H32].
assert (* AndElim *) ((euclidean__axioms.Col F A M) /\ ((euclidean__axioms.Col A M F) /\ ((euclidean__axioms.Col M A F) /\ (euclidean__axioms.Col A F M)))) as H33.
------------------------------ exact H32.
------------------------------ destruct H33 as [H33 H34].
assert (* AndElim *) ((euclidean__axioms.Col A M F) /\ ((euclidean__axioms.Col M A F) /\ (euclidean__axioms.Col A F M))) as H35.
------------------------------- exact H34.
------------------------------- destruct H35 as [H35 H36].
assert (* AndElim *) ((euclidean__axioms.Col M A F) /\ (euclidean__axioms.Col A F M)) as H37.
-------------------------------- exact H36.
...
----------------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (E) (M) (F) H16).
----------------------------- assert (* AndElim *) ((euclidean__axioms.neq M F) /\ ((euclidean__axioms.neq E M) /\ (euclidean__axioms.neq E F))) as H32.
------------------------------ exact H31.
------------------------------ destruct H32 as [H32 H33].
assert (* AndElim *) ((euclidean__axioms.neq E M) /\ (euclidean__axioms.neq E F)) as H34.
------------------------------- exact H33.
...
-------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong F M E M) /\ ((euclidean__axioms.Cong F M M E) /\ (euclidean__axioms.Cong M F E M))) as H35.
--------------------------------- exact H34.
--------------------------------- destruct H35 as [H35 H36].
assert (* AndElim *) ((euclidean__axioms.Cong F M M E) /\ (euclidean__axioms.Cong M F E M)) as H37.
---------------------------------- exact H36.
---------------------------------- destruct H37 as [H37 H38].
exact H37.
------------------------------- assert (* Cut *) (euclidean__defs.Per F M P) as H35.
-------------------------------- exact H33.
...
----------------------------------- assert (* Cut *) (euclidean__axioms.BetS F M E) as H39.
------------------------------------ exact H36.
...
-------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong P F P E) /\ ((euclidean__axioms.Cong P F E P) /\ (euclidean__axioms.Cong F P P E))) as H41.
--------------------------------------- exact H40.
--------------------------------------- destruct H41 as [H41 H42].
assert (* AndElim *) ((euclidean__axioms.Cong P F E P) /\ (euclidean__axioms.Cong F P P E)) as H43.
---------------------------------------- exact H42.
