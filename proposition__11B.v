...
Definition proposition__11B : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (P: euclidean__axioms.Point), (euclidean__axioms.BetS A C B) -> ((euclidean__axioms.nCol A B P) -> (exists (X: euclidean__axioms.Point), (euclidean__defs.Per A C X) /\ (euclidean__axioms.TS X A B P))).
Proof.
intro A.
intro B.
intro C.
...
intro H.
intro H0.
assert (* Cut *) (exists (M: euclidean__axioms.Point), (euclidean__axioms.nCol A B M) /\ ((euclidean__defs.OS M P A B) /\ (~(euclidean__defs.Per A C M)))) as H1.
- apply (@lemma__notperp.lemma__notperp (A) (B) (C) (P) (H) H0).
- assert (exists M: euclidean__axioms.Point, ((euclidean__axioms.nCol A B M) /\ ((euclidean__defs.OS M P A B) /\ (~(euclidean__defs.Per A C M))))) as H2.
-- exact H1.
-- destruct H2 as [M H2].
assert (* AndElim *) ((euclidean__axioms.nCol A B M) /\ ((euclidean__defs.OS M P A B) /\ (~(euclidean__defs.Per A C M)))) as H3.
--- exact H2.
--- destruct H3 as [H3 H4].
assert (* AndElim *) ((euclidean__defs.OS M P A B) /\ (~(euclidean__defs.Per A C M))) as H5.
---- exact H4.
...
------ assert (* AndElim *) ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B))) as H8.
------- exact H7.
------- destruct H8 as [H8 H9].
assert (* AndElim *) ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B)) as H10.
-------- exact H9.
-------- destruct H10 as [H10 H11].
exact H11.
----- assert (* Cut *) (exists (Q: euclidean__axioms.Point), euclidean__defs.Perp__at M Q A B Q) as H8.
------ apply (@proposition__12.proposition__12 (A) (B) (M) H3).
------ assert (exists Q: euclidean__axioms.Point, (euclidean__defs.Perp__at M Q A B Q)) as H9.
------- exact H8.
------- destruct H9 as [Q H9].
assert (* Cut *) (exists (E: euclidean__axioms.Point), (euclidean__axioms.Col M Q Q) /\ ((euclidean__axioms.Col A B Q) /\ ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E Q M)))) as H10.
-------- exact H9.
-------- assert (exists E: euclidean__axioms.Point, ((euclidean__axioms.Col M Q Q) /\ ((euclidean__axioms.Col A B Q) /\ ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E Q M))))) as H11.
--------- exact H10.
--------- destruct H11 as [E H11].
assert (* AndElim *) ((euclidean__axioms.Col M Q Q) /\ ((euclidean__axioms.Col A B Q) /\ ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E Q M)))) as H12.
---------- exact H11.
---------- destruct H12 as [H12 H13].
assert (* AndElim *) ((euclidean__axioms.Col A B Q) /\ ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E Q M))) as H14.
----------- exact H13.
----------- destruct H14 as [H14 H15].
assert (* AndElim *) ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E Q M)) as H16.
------------ exact H15.
------------ destruct H16 as [H16 H17].
assert (* Cut *) (~(M = Q)) as H18.
------------- intro H18.
assert (* Cut *) (euclidean__axioms.Col A B M) as H19.
-------------- apply (@eq__ind__r euclidean__axioms.Point Q (fun M0: euclidean__axioms.Point => (euclidean__axioms.nCol A B M0) -> ((euclidean__defs.OS M0 P A B) -> ((~(euclidean__defs.Per A C M0)) -> ((euclidean__defs.Perp__at M0 Q A B Q) -> ((euclidean__axioms.Col M0 Q Q) -> ((euclidean__defs.Per E Q M0) -> (euclidean__axioms.Col A B M0)))))))) with (x := M).
---------------intro H19.
intro H20.
intro H21.
intro H22.
...
----------------- assert (* AndElim *) ((euclidean__axioms.Col B A E) /\ ((euclidean__axioms.Col B E A) /\ ((euclidean__axioms.Col E A B) /\ ((euclidean__axioms.Col A E B) /\ (euclidean__axioms.Col E B A))))) as H22.
------------------ exact H21.
------------------ destruct H22 as [H22 H23].
assert (* AndElim *) ((euclidean__axioms.Col B E A) /\ ((euclidean__axioms.Col E A B) /\ ((euclidean__axioms.Col A E B) /\ (euclidean__axioms.Col E B A)))) as H24.
------------------- exact H23.
------------------- destruct H24 as [H24 H25].
assert (* AndElim *) ((euclidean__axioms.Col E A B) /\ ((euclidean__axioms.Col A E B) /\ (euclidean__axioms.Col E B A))) as H26.
-------------------- exact H25.
-------------------- destruct H26 as [H26 H27].
assert (* AndElim *) ((euclidean__axioms.Col A E B) /\ (euclidean__axioms.Col E B A)) as H28.
--------------------- exact H27.
...
-------------------- apply (@eq__ind__r euclidean__axioms.Point Q (fun C0: euclidean__axioms.Point => (euclidean__axioms.BetS A C0 B) -> ((~(euclidean__defs.Per A C0 M)) -> ((euclidean__axioms.Col A B C0) -> ((euclidean__axioms.Col B A C0) -> (euclidean__defs.Per E C0 M)))))) with (x := C).
---------------------intro H25.
intro H26.
intro H27.
intro H28.
...
----------------------- assert (* AndElim *) ((euclidean__axioms.Col E A C) /\ ((euclidean__axioms.Col E C A) /\ ((euclidean__axioms.Col C A E) /\ ((euclidean__axioms.Col A C E) /\ (euclidean__axioms.Col C E A))))) as H28.
------------------------ exact H27.
------------------------ destruct H28 as [H28 H29].
assert (* AndElim *) ((euclidean__axioms.Col E C A) /\ ((euclidean__axioms.Col C A E) /\ ((euclidean__axioms.Col A C E) /\ (euclidean__axioms.Col C E A)))) as H30.
------------------------- exact H29.
------------------------- destruct H30 as [H30 H31].
assert (* AndElim *) ((euclidean__axioms.Col C A E) /\ ((euclidean__axioms.Col A C E) /\ (euclidean__axioms.Col C E A))) as H32.
-------------------------- exact H31.
-------------------------- destruct H32 as [H32 H33].
assert (* AndElim *) ((euclidean__axioms.Col A C E) /\ (euclidean__axioms.Col C E A)) as H34.
--------------------------- exact H33.
...
------------------------ apply (@lemma__betweennotequal.lemma__betweennotequal (A) (C) (B) H).
------------------------ assert (* AndElim *) ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B))) as H29.
------------------------- exact H28.
------------------------- destruct H29 as [H29 H30].
assert (* AndElim *) ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B)) as H31.
-------------------------- exact H30.
...
---------------------- assert (* AndElim *) ((euclidean__axioms.Col Q C E) /\ ((euclidean__axioms.Col Q E C) /\ ((euclidean__axioms.Col E C Q) /\ ((euclidean__axioms.Col C E Q) /\ (euclidean__axioms.Col E Q C))))) as H27.
----------------------- exact H26.
----------------------- destruct H27 as [H27 H28].
assert (* AndElim *) ((euclidean__axioms.Col Q E C) /\ ((euclidean__axioms.Col E C Q) /\ ((euclidean__axioms.Col C E Q) /\ (euclidean__axioms.Col E Q C)))) as H29.
------------------------ exact H28.
------------------------ destruct H29 as [H29 H30].
assert (* AndElim *) ((euclidean__axioms.Col E C Q) /\ ((euclidean__axioms.Col C E Q) /\ (euclidean__axioms.Col E Q C))) as H31.
------------------------- exact H30.
------------------------- destruct H31 as [H31 H32].
assert (* AndElim *) ((euclidean__axioms.Col C E Q) /\ (euclidean__axioms.Col E Q C)) as H33.
-------------------------- exact H32.
...
----------------------- assert (* Cut *) (exists (G: euclidean__axioms.Point), (euclidean__axioms.BetS Q G C) /\ (euclidean__axioms.Cong G Q G C)) as H29.
------------------------ apply (@proposition__10.proposition__10 (Q) (C) H28).
------------------------ assert (exists G: euclidean__axioms.Point, ((euclidean__axioms.BetS Q G C) /\ (euclidean__axioms.Cong G Q G C))) as H30.
------------------------- exact H29.
------------------------- destruct H30 as [G H30].
assert (* AndElim *) ((euclidean__axioms.BetS Q G C) /\ (euclidean__axioms.Cong G Q G C)) as H31.
-------------------------- exact H30.
-------------------------- destruct H31 as [H31 H32].
assert (* Cut *) (~(M = G)) as H33.
--------------------------- intro H33.
assert (* Cut *) (euclidean__axioms.BetS Q M C) as H34.
---------------------------- apply (@eq__ind__r euclidean__axioms.Point G (fun M0: euclidean__axioms.Point => (euclidean__axioms.nCol A B M0) -> ((euclidean__defs.OS M0 P A B) -> ((~(euclidean__defs.Per A C M0)) -> ((euclidean__defs.Perp__at M0 Q A B Q) -> ((euclidean__axioms.Col M0 Q Q) -> ((euclidean__defs.Per E Q M0) -> ((~(M0 = Q)) -> ((euclidean__axioms.neq Q M0) -> ((euclidean__defs.Per C Q M0) -> (euclidean__axioms.BetS Q M0 C))))))))))) with (x := M).
-----------------------------intro H34.
intro H35.
intro H36.
intro H37.
...
-------------------------------- assert (* AndElim *) ((euclidean__axioms.Col M Q C) /\ ((euclidean__axioms.Col M C Q) /\ ((euclidean__axioms.Col C Q M) /\ ((euclidean__axioms.Col Q C M) /\ (euclidean__axioms.Col C M Q))))) as H38.
--------------------------------- exact H37.
--------------------------------- destruct H38 as [H38 H39].
assert (* AndElim *) ((euclidean__axioms.Col M C Q) /\ ((euclidean__axioms.Col C Q M) /\ ((euclidean__axioms.Col Q C M) /\ (euclidean__axioms.Col C M Q)))) as H40.
---------------------------------- exact H39.
---------------------------------- destruct H40 as [H40 H41].
assert (* AndElim *) ((euclidean__axioms.Col C Q M) /\ ((euclidean__axioms.Col Q C M) /\ (euclidean__axioms.Col C M Q))) as H42.
----------------------------------- exact H41.
----------------------------------- destruct H42 as [H42 H43].
assert (* AndElim *) ((euclidean__axioms.Col Q C M) /\ (euclidean__axioms.Col C M Q)) as H44.
------------------------------------ exact H43.
...
--------------------------------- assert (* AndElim *) ((euclidean__axioms.Col Q B C) /\ ((euclidean__axioms.Col Q C B) /\ ((euclidean__axioms.Col C B Q) /\ ((euclidean__axioms.Col B C Q) /\ (euclidean__axioms.Col C Q B))))) as H39.
---------------------------------- exact H38.
---------------------------------- destruct H39 as [H39 H40].
assert (* AndElim *) ((euclidean__axioms.Col Q C B) /\ ((euclidean__axioms.Col C B Q) /\ ((euclidean__axioms.Col B C Q) /\ (euclidean__axioms.Col C Q B)))) as H41.
----------------------------------- exact H40.
----------------------------------- destruct H41 as [H41 H42].
assert (* AndElim *) ((euclidean__axioms.Col C B Q) /\ ((euclidean__axioms.Col B C Q) /\ (euclidean__axioms.Col C Q B))) as H43.
------------------------------------ exact H42.
------------------------------------ destruct H43 as [H43 H44].
assert (* AndElim *) ((euclidean__axioms.Col B C Q) /\ (euclidean__axioms.Col C Q B)) as H45.
------------------------------------- exact H44.
...
---------------------------------- assert (* AndElim *) ((euclidean__axioms.neq M C) /\ ((euclidean__axioms.neq Q M) /\ (euclidean__axioms.neq Q C))) as H40.
----------------------------------- exact H39.
----------------------------------- destruct H40 as [H40 H41].
assert (* AndElim *) ((euclidean__axioms.neq Q M) /\ (euclidean__axioms.neq Q C)) as H42.
------------------------------------ exact H41.
------------------------------------ destruct H42 as [H42 H43].
exact H43.
...
------------------------------------ assert (* AndElim *) ((euclidean__axioms.Col M C B) /\ ((euclidean__axioms.Col M B C) /\ ((euclidean__axioms.Col B C M) /\ ((euclidean__axioms.Col C B M) /\ (euclidean__axioms.Col B M C))))) as H42.
------------------------------------- exact H41.
------------------------------------- destruct H42 as [H42 H43].
assert (* AndElim *) ((euclidean__axioms.Col M B C) /\ ((euclidean__axioms.Col B C M) /\ ((euclidean__axioms.Col C B M) /\ (euclidean__axioms.Col B M C)))) as H44.
-------------------------------------- exact H43.
-------------------------------------- destruct H44 as [H44 H45].
assert (* AndElim *) ((euclidean__axioms.Col B C M) /\ ((euclidean__axioms.Col C B M) /\ (euclidean__axioms.Col B M C))) as H46.
--------------------------------------- exact H45.
--------------------------------------- destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Col C B M) /\ (euclidean__axioms.Col B M C)) as H48.
---------------------------------------- exact H47.
...
-------------------------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (A) (C) (B) H).
-------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B))) as H44.
--------------------------------------- exact H43.
--------------------------------------- destruct H44 as [H44 H45].
assert (* AndElim *) ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B)) as H46.
---------------------------------------- exact H45.
---------------------------------------- destruct H46 as [H46 H47].
exact H44.
...
---------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col M B A) /\ ((euclidean__axioms.Col M A B) /\ ((euclidean__axioms.Col A B M) /\ ((euclidean__axioms.Col B A M) /\ (euclidean__axioms.Col A M B))))) as H46.
----------------------------------------- exact H45.
----------------------------------------- destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Col M A B) /\ ((euclidean__axioms.Col A B M) /\ ((euclidean__axioms.Col B A M) /\ (euclidean__axioms.Col A M B)))) as H48.
------------------------------------------ exact H47.
------------------------------------------ destruct H48 as [H48 H49].
assert (* AndElim *) ((euclidean__axioms.Col A B M) /\ ((euclidean__axioms.Col B A M) /\ (euclidean__axioms.Col A M B))) as H50.
------------------------------------------- exact H49.
------------------------------------------- destruct H50 as [H50 H51].
assert (* AndElim *) ((euclidean__axioms.Col B A M) /\ (euclidean__axioms.Col A M B)) as H52.
-------------------------------------------- exact H51.
-------------------------------------------- destruct H52 as [H52 H53].
exact H50.
--------------------------------------- apply (@euclidean__tactics.Col__nCol__False (A) (B) (M) (H3) H45).
--------------------------- assert (* Cut *) (exists (H34: euclidean__axioms.Point), (euclidean__axioms.BetS M G H34) /\ (euclidean__axioms.Cong G H34 M G)) as H34.
---------------------------- apply (@lemma__extension.lemma__extension (M) (G) (M) (G) (H33) H33).
---------------------------- assert (exists H35: euclidean__axioms.Point, ((euclidean__axioms.BetS M G H35) /\ (euclidean__axioms.Cong G H35 M G))) as H36.
----------------------------- exact H34.
----------------------------- destruct H36 as [H35 H36].
assert (* AndElim *) ((euclidean__axioms.BetS M G H35) /\ (euclidean__axioms.Cong G H35 M G)) as H37.
------------------------------ exact H36.
...
---------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong Q G C G) /\ ((euclidean__axioms.Cong Q G G C) /\ (euclidean__axioms.Cong G Q C G))) as H42.
----------------------------------- exact H41.
----------------------------------- destruct H42 as [H42 H43].
assert (* AndElim *) ((euclidean__axioms.Cong Q G G C) /\ (euclidean__axioms.Cong G Q C G)) as H44.
------------------------------------ exact H43.
------------------------------------ destruct H44 as [H44 H45].
exact H44.
...
------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col G Q C) /\ ((euclidean__axioms.Col G C Q) /\ ((euclidean__axioms.Col C Q G) /\ ((euclidean__axioms.Col Q C G) /\ (euclidean__axioms.Col C G Q))))) as H45.
-------------------------------------- exact H44.
-------------------------------------- destruct H45 as [H45 H46].
assert (* AndElim *) ((euclidean__axioms.Col G C Q) /\ ((euclidean__axioms.Col C Q G) /\ ((euclidean__axioms.Col Q C G) /\ (euclidean__axioms.Col C G Q)))) as H47.
--------------------------------------- exact H46.
--------------------------------------- destruct H47 as [H47 H48].
assert (* AndElim *) ((euclidean__axioms.Col C Q G) /\ ((euclidean__axioms.Col Q C G) /\ (euclidean__axioms.Col C G Q))) as H49.
---------------------------------------- exact H48.
---------------------------------------- destruct H49 as [H49 H50].
assert (* AndElim *) ((euclidean__axioms.Col Q C G) /\ (euclidean__axioms.Col C G Q)) as H51.
----------------------------------------- exact H50.
...
-------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq G C) /\ ((euclidean__axioms.neq Q G) /\ (euclidean__axioms.neq Q C))) as H46.
--------------------------------------- exact H45.
--------------------------------------- destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.neq Q G) /\ (euclidean__axioms.neq Q C)) as H48.
---------------------------------------- exact H47.
---------------------------------------- destruct H48 as [H48 H49].
exact H48.
...
--------------------------------------- assert (* Cut *) (exists (J: euclidean__axioms.Point), (euclidean__axioms.BetS M Q J) /\ (euclidean__axioms.Cong Q J M Q)) as H48.
---------------------------------------- apply (@lemma__extension.lemma__extension (M) (Q) (M) (Q) (H18) H18).
---------------------------------------- assert (exists J: euclidean__axioms.Point, ((euclidean__axioms.BetS M Q J) /\ (euclidean__axioms.Cong Q J M Q))) as H49.
----------------------------------------- exact H48.
----------------------------------------- destruct H49 as [J H49].
assert (* AndElim *) ((euclidean__axioms.BetS M Q J) /\ (euclidean__axioms.Cong Q J M Q)) as H50.
------------------------------------------ exact H49.
------------------------------------------ destruct H50 as [H50 H51].
...
------------------------------------------------ assert (* AndElim *) ((euclidean__axioms.Cong J Q Q M) /\ ((euclidean__axioms.Cong J Q M Q) /\ (euclidean__axioms.Cong Q J Q M))) as H57.
------------------------------------------------- exact H56.
------------------------------------------------- destruct H57 as [H57 H58].
assert (* AndElim *) ((euclidean__axioms.Cong J Q M Q) /\ (euclidean__axioms.Cong Q J Q M)) as H59.
-------------------------------------------------- exact H58.
...
-------------------------------------------------- assert (* Cut *) (exists (K: euclidean__axioms.Point), (euclidean__axioms.BetS J G K) /\ (euclidean__axioms.Cong G K J G)) as H60.
--------------------------------------------------- apply (@lemma__extension.lemma__extension (J) (G) (J) (G) (H59) H59).
--------------------------------------------------- assert (exists K: euclidean__axioms.Point, ((euclidean__axioms.BetS J G K) /\ (euclidean__axioms.Cong G K J G))) as H61.
---------------------------------------------------- exact H60.
---------------------------------------------------- destruct H61 as [K H61].
assert (* AndElim *) ((euclidean__axioms.BetS J G K) /\ (euclidean__axioms.Cong G K J G)) as H62.
----------------------------------------------------- exact H61.
...
---------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq Q M) /\ ((euclidean__axioms.neq J Q) /\ (euclidean__axioms.neq J M))) as H68.
----------------------------------------------------------- exact H67.
----------------------------------------------------------- destruct H68 as [H68 H69].
assert (* AndElim *) ((euclidean__axioms.neq J Q) /\ (euclidean__axioms.neq J M)) as H70.
------------------------------------------------------------ exact H69.
...
------------------------------------------------------------ assert (* AndElim *) ((euclidean__axioms.neq Q J) /\ ((euclidean__axioms.neq M Q) /\ (euclidean__axioms.neq M J))) as H70.
------------------------------------------------------------- exact H69.
------------------------------------------------------------- destruct H70 as [H70 H71].
assert (* AndElim *) ((euclidean__axioms.neq M Q) /\ (euclidean__axioms.neq M J)) as H72.
-------------------------------------------------------------- exact H71.
...
---------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong H35 G G M) /\ ((euclidean__axioms.Cong H35 G M G) /\ (euclidean__axioms.Cong G H35 G M))) as H74.
----------------------------------------------------------------- exact H73.
----------------------------------------------------------------- destruct H74 as [H74 H75].
assert (* AndElim *) ((euclidean__axioms.Cong H35 G M G) /\ (euclidean__axioms.Cong G H35 G M)) as H76.
------------------------------------------------------------------ exact H75.
...
----------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong G M G J) /\ ((euclidean__axioms.Cong G M J G) /\ (euclidean__axioms.Cong M G G J))) as H75.
------------------------------------------------------------------ exact H74.
------------------------------------------------------------------ destruct H75 as [H75 H76].
assert (* AndElim *) ((euclidean__axioms.Cong G M J G) /\ (euclidean__axioms.Cong M G G J)) as H77.
------------------------------------------------------------------- exact H76.
...
----------------------------------------------------------------- assert (* Cut *) (euclidean__axioms.Cong J G G K) as H76.
------------------------------------------------------------------ exact H64.
...
--------------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong G H35 K G) /\ ((euclidean__axioms.Cong G H35 G K) /\ (euclidean__axioms.Cong H35 G K G))) as H79.
---------------------------------------------------------------------- exact H78.
---------------------------------------------------------------------- destruct H79 as [H79 H80].
assert (* AndElim *) ((euclidean__axioms.Cong G H35 G K) /\ (euclidean__axioms.Cong H35 G K G)) as H81.
----------------------------------------------------------------------- exact H80.
...
---------------------------------------------------------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (Q) (G) (C) H31).
---------------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq G C) /\ ((euclidean__axioms.neq Q G) /\ (euclidean__axioms.neq Q C))) as H80.
----------------------------------------------------------------------- exact H79.
----------------------------------------------------------------------- destruct H80 as [H80 H81].
assert (* AndElim *) ((euclidean__axioms.neq Q G) /\ (euclidean__axioms.neq Q C)) as H82.
------------------------------------------------------------------------ exact H81.
...
---------------------------------------------------------------------- assert (* Cut *) (euclidean__axioms.Cong M Q Q J) as H81.
----------------------------------------------------------------------- exact H52.
...
--------------------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong C H35 K C) /\ ((euclidean__axioms.Cong C H35 C K) /\ (euclidean__axioms.Cong H35 C K C))) as H85.
---------------------------------------------------------------------------- exact H84.
---------------------------------------------------------------------------- destruct H85 as [H85 H86].
assert (* AndElim *) ((euclidean__axioms.Cong C H35 C K) /\ (euclidean__axioms.Cong H35 C K C)) as H87.
----------------------------------------------------------------------------- exact H86.
...
---------------------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq C K) /\ ((euclidean__axioms.neq H35 C) /\ (euclidean__axioms.neq H35 K))) as H86.
----------------------------------------------------------------------------- exact H85.
----------------------------------------------------------------------------- destruct H86 as [H86 H87].
assert (* AndElim *) ((euclidean__axioms.neq H35 C) /\ (euclidean__axioms.neq H35 K)) as H88.
------------------------------------------------------------------------------ exact H87.
...
----------------------------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col Q C G) /\ ((euclidean__axioms.Col Q G C) /\ ((euclidean__axioms.Col G C Q) /\ ((euclidean__axioms.Col C G Q) /\ (euclidean__axioms.Col G Q C))))) as H93.
------------------------------------------------------------------------------------ exact H92.
------------------------------------------------------------------------------------ destruct H93 as [H93 H94].
assert (* AndElim *) ((euclidean__axioms.Col Q G C) /\ ((euclidean__axioms.Col G C Q) /\ ((euclidean__axioms.Col C G Q) /\ (euclidean__axioms.Col G Q C)))) as H95.
------------------------------------------------------------------------------------- exact H94.
------------------------------------------------------------------------------------- destruct H95 as [H95 H96].
assert (* AndElim *) ((euclidean__axioms.Col G C Q) /\ ((euclidean__axioms.Col C G Q) /\ (euclidean__axioms.Col G Q C))) as H97.
-------------------------------------------------------------------------------------- exact H96.
-------------------------------------------------------------------------------------- destruct H97 as [H97 H98].
assert (* AndElim *) ((euclidean__axioms.Col C G Q) /\ (euclidean__axioms.Col G Q C)) as H99.
--------------------------------------------------------------------------------------- exact H98.
...
------------------------------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col A C G) /\ ((euclidean__axioms.Col A G C) /\ ((euclidean__axioms.Col G C A) /\ ((euclidean__axioms.Col C G A) /\ (euclidean__axioms.Col G A C))))) as H95.
-------------------------------------------------------------------------------------- exact H94.
-------------------------------------------------------------------------------------- destruct H95 as [H95 H96].
assert (* AndElim *) ((euclidean__axioms.Col A G C) /\ ((euclidean__axioms.Col G C A) /\ ((euclidean__axioms.Col C G A) /\ (euclidean__axioms.Col G A C)))) as H97.
--------------------------------------------------------------------------------------- exact H96.
--------------------------------------------------------------------------------------- destruct H97 as [H97 H98].
assert (* AndElim *) ((euclidean__axioms.Col G C A) /\ ((euclidean__axioms.Col C G A) /\ (euclidean__axioms.Col G A C))) as H99.
---------------------------------------------------------------------------------------- exact H98.
---------------------------------------------------------------------------------------- destruct H99 as [H99 H100].
assert (* AndElim *) ((euclidean__axioms.Col C G A) /\ (euclidean__axioms.Col G A C)) as H101.
----------------------------------------------------------------------------------------- exact H100.
...
-------------------------------------------------------------------------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (A) (C) (B) H).
-------------------------------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B))) as H96.
--------------------------------------------------------------------------------------- exact H95.
--------------------------------------------------------------------------------------- destruct H96 as [H96 H97].
assert (* AndElim *) ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B)) as H98.
---------------------------------------------------------------------------------------- exact H97.
...
---------------------------------------------------------------------------------------- apply (@lemma__collinearorder.lemma__collinearorder (B) (A) (C) H22).
---------------------------------------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col A B C) /\ ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B))))) as H98.
----------------------------------------------------------------------------------------- exact H97.
----------------------------------------------------------------------------------------- destruct H98 as [H98 H99].
assert (* AndElim *) ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B)))) as H100.
------------------------------------------------------------------------------------------ exact H99.
------------------------------------------------------------------------------------------ destruct H100 as [H100 H101].
assert (* AndElim *) ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B))) as H102.
------------------------------------------------------------------------------------------- exact H101.
------------------------------------------------------------------------------------------- destruct H102 as [H102 H103].
assert (* AndElim *) ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B)) as H104.
-------------------------------------------------------------------------------------------- exact H103.
...
-------------------------------------------------------------------------------------------- assert (* AndElim *) ((euclidean__defs.OS P M A B) /\ ((euclidean__defs.OS M P B A) /\ (euclidean__defs.OS P M B A))) as H102.
--------------------------------------------------------------------------------------------- exact H101.
--------------------------------------------------------------------------------------------- destruct H102 as [H102 H103].
assert (* AndElim *) ((euclidean__defs.OS M P B A) /\ (euclidean__defs.OS P M B A)) as H104.
---------------------------------------------------------------------------------------------- exact H103.
---------------------------------------------------------------------------------------------- destruct H104 as [H104 H105].
exact H102.
