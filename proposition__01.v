...
Definition proposition__01 : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point), (euclidean__axioms.neq A B) -> (exists (X: euclidean__axioms.Point), (euclidean__defs.equilateral A B X) /\ (euclidean__axioms.Triangle A B X)).
Proof.
intro A.
intro B.
intro H.
assert (* Cut *) (exists (J: euclidean__axioms.Circle), euclidean__axioms.CI J A A B) as H0.
- apply (@euclidean__axioms.postulate__Euclid3 (A) (B) H).
- assert (exists J: euclidean__axioms.Circle, (euclidean__axioms.CI J A A B)) as H1.
-- exact H0.
-- destruct H1 as [J H1].
assert (* Cut *) (euclidean__axioms.neq B A) as H2.
--- apply (@lemma__inequalitysymmetric.lemma__inequalitysymmetric (A) (B) H).
--- assert (* Cut *) (exists (K: euclidean__axioms.Circle), euclidean__axioms.CI K B B A) as H3.
---- apply (@euclidean__axioms.postulate__Euclid3 (B) (A) H2).
---- assert (exists K: euclidean__axioms.Circle, (euclidean__axioms.CI K B B A)) as H4.
----- exact H3.
----- destruct H4 as [K H4].
assert (* Cut *) (exists (D: euclidean__axioms.Point), (euclidean__axioms.BetS B A D) /\ (euclidean__axioms.Cong A D A B)) as H5.
------ apply (@lemma__localextension.lemma__localextension (B) (A) (B) (H2) H).
------ assert (exists D: euclidean__axioms.Point, ((euclidean__axioms.BetS B A D) /\ (euclidean__axioms.Cong A D A B))) as H6.
------- exact H5.
------- destruct H6 as [D H6].
assert (* AndElim *) ((euclidean__axioms.BetS B A D) /\ (euclidean__axioms.Cong A D A B)) as H7.
-------- exact H6.
...
------------------ left.
exact H16.
----------------- assert (* Cut *) (exists (C: euclidean__axioms.Point), (euclidean__axioms.OnCirc C K) /\ (euclidean__axioms.OnCirc C J)) as H18.
------------------ apply (@euclidean__axioms.postulate__circle__circle (B) (A) (A) (B) (K) (J) (B) (D) (B) (A) (H4) (H12) (H10) (H1) (H14) H15).
------------------ assert (exists C: euclidean__axioms.Point, ((euclidean__axioms.OnCirc C K) /\ (euclidean__axioms.OnCirc C J))) as H19.
------------------- exact H18.
------------------- destruct H19 as [C H19].
assert (* AndElim *) ((euclidean__axioms.OnCirc C K) /\ (euclidean__axioms.OnCirc C J)) as H20.
-------------------- exact H19.
...
------------------------- assert (* AndElim *) ((euclidean__axioms.Cong C B A B) /\ ((euclidean__axioms.Cong C B B A) /\ (euclidean__axioms.Cong B C A B))) as H26.
-------------------------- exact H25.
-------------------------- destruct H26 as [H26 H27].
assert (* AndElim *) ((euclidean__axioms.Cong C B B A) /\ (euclidean__axioms.Cong B C A B)) as H28.
--------------------------- exact H27.
...
----------------------------------- assert (* Cut *) (euclidean__axioms.Cong A C C A) as H37.
------------------------------------ exact H28.
------------------------------------ assert (* Cut *) (euclidean__axioms.Cong A C A B) as H38.
------------------------------------- exact H22.
------------------------------------- apply (@H34 H38).
...
------------------------------------ apply (@euclidean__axioms.cn__equalityreverse (C) A).
------------------------------------ assert (* Cut *) (euclidean__axioms.Cong A B A C) as H38.
------------------------------------- exact H23.
------------------------------------- apply (@H35 H38).
...
------------------------------------ assert (* Cut *) ((A = B) \/ ((A = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))))) as H38.
------------------------------------- exact H36.
------------------------------------- assert (A = B \/ (A = C) \/ ((B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B))))) as H39.
-------------------------------------- exact H38.
-------------------------------------- destruct H39 as [H39|H39].
--------------------------------------- apply (@H H39).
--------------------------------------- assert (A = C \/ (B = C) \/ ((euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)))) as H40.
---------------------------------------- exact H39.
---------------------------------------- destruct H40 as [H40|H40].
----------------------------------------- apply (@H37 H40).
----------------------------------------- assert (B = C \/ (euclidean__axioms.BetS B A C) \/ ((euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B))) as H41.
------------------------------------------ exact H40.
------------------------------------------ destruct H41 as [H41|H41].
------------------------------------------- apply (@H31 H41).
------------------------------------------- assert (euclidean__axioms.BetS B A C \/ (euclidean__axioms.BetS A B C) \/ (euclidean__axioms.BetS A C B)) as H42.
-------------------------------------------- exact H41.
...
-----------------------------------------------exact H43.
----------------------------------------------- contradiction.
--------------------------------------------- assert (euclidean__axioms.BetS A B C \/ euclidean__axioms.BetS A C B) as H43.
---------------------------------------------- exact H42.
