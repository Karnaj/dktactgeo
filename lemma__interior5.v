...
Definition lemma__interior5 : forall A B C D a b c d, (euclidean__axioms.BetS A B C) -> ((euclidean__axioms.BetS a b c) -> ((euclidean__axioms.Cong A B a b) -> ((euclidean__axioms.Cong B C b c) -> ((euclidean__axioms.Cong A D a d) -> ((euclidean__axioms.Cong C D c d) -> (euclidean__axioms.Cong B D b d)))))).
Proof.
intro A.
intro B.
intro C.
...
---- apply (@H6 H8).
--- assert (* Cut *) (exists M, (euclidean__axioms.BetS C A M) /\ (euclidean__axioms.Cong A M B C)) as H8.
...
----------- apply (@H16 H18).
---------- assert (* Cut *) (exists m, (euclidean__axioms.BetS c a m) /\ (euclidean__axioms.Cong a m b c)) as H18.
----------- apply (@lemma__extension.lemma__extension c a b c H17 H15).
----------- destruct H18 as [m H19].
