...
Definition lemma__rightangleNC : forall A B C, (euclidean__defs.Per A B C) -> (euclidean__axioms.nCol A B C).
Proof.
intro A.
intro B.
intro C.
...
------ apply (@eq__ind__r euclidean__axioms.Point A (fun C0 => (euclidean__defs.Per A B C0) -> ((euclidean__axioms.Cong A C0 D C0) -> ((euclidean__axioms.neq B C0) -> ((~(euclidean__axioms.BetS A C0 D)) -> (euclidean__axioms.Cong C0 C0 D C0)))))) with (x := C).
-------intro H13.
intro H14.
intro H15.
intro H16.
...
intro H25.
intro H26.
apply (@eq__ind euclidean__axioms.Point C (fun A0 => (euclidean__defs.Per A0 B C) -> ((euclidean__axioms.Cong A0 C A0 C) -> ((euclidean__axioms.Cong A0 B A0 B) -> ((euclidean__axioms.BetS A0 B A0) -> ((~(euclidean__axioms.BetS A0 C A0)) -> ((euclidean__defs.Midpoint A0 B A0) -> ((euclidean__axioms.Cong A0 B B A0) -> ((euclidean__axioms.neq A0 B) -> ((~(euclidean__axioms.neq A0 C)) -> ((euclidean__axioms.Cong A0 C C C) -> ((euclidean__axioms.Cong C C A0 C) -> ((A0 = C) -> (A0 = A0)))))))))))))) with (y := A).
-------------intro H27.
intro H28.
intro H29.
intro H30.
...
intro H37.
intro H38.
assert (C = C) as H39 by exact H38.
exact H39.
...
------- apply (@eq__ind__r euclidean__axioms.Point D (fun C0 => (euclidean__defs.Per A B C0) -> ((euclidean__axioms.Cong A C0 D C0) -> ((euclidean__axioms.neq B C0) -> ((~(euclidean__axioms.BetS A C0 D)) -> ((~(C0 = A)) -> (euclidean__axioms.Cong A C0 D D))))))) with (x := C).
--------intro H14.
intro H15.
intro H16.
intro H17.
...
----------- apply (@H15 H16).
---------- assert (False) as H17 by exact H16.
contradiction H17.
--------- apply (@H12 H16).
