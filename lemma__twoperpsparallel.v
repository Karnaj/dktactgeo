...
Definition lemma__twoperpsparallel : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (D: euclidean__axioms.Point), (euclidean__defs.Per A B C) -> ((euclidean__defs.Per B C D) -> ((euclidean__defs.OS A D B C) -> (euclidean__defs.Par A B C D))).
Proof.
intro A.
intro B.
intro C.
...
--- assert (* AndElim *) ((euclidean__axioms.neq A B) /\ ((euclidean__axioms.neq B C) /\ ((euclidean__axioms.neq A C) /\ ((euclidean__axioms.neq B A) /\ ((euclidean__axioms.neq C B) /\ (euclidean__axioms.neq C A)))))) as H4.
---- exact H3.
---- destruct H4 as [H4 H5].
assert (* AndElim *) ((euclidean__axioms.neq B C) /\ ((euclidean__axioms.neq A C) /\ ((euclidean__axioms.neq B A) /\ ((euclidean__axioms.neq C B) /\ (euclidean__axioms.neq C A))))) as H6.
----- exact H5.
----- destruct H6 as [H6 H7].
assert (* AndElim *) ((euclidean__axioms.neq A C) /\ ((euclidean__axioms.neq B A) /\ ((euclidean__axioms.neq C B) /\ (euclidean__axioms.neq C A)))) as H8.
------ exact H7.
------ destruct H8 as [H8 H9].
assert (* AndElim *) ((euclidean__axioms.neq B A) /\ ((euclidean__axioms.neq C B) /\ (euclidean__axioms.neq C A))) as H10.
------- exact H9.
------- destruct H10 as [H10 H11].
assert (* AndElim *) ((euclidean__axioms.neq C B) /\ (euclidean__axioms.neq C A)) as H12.
-------- exact H11.
-------- destruct H12 as [H12 H13].
exact H6.
-- assert (* Cut *) (exists (E: euclidean__axioms.Point), (euclidean__axioms.BetS B C E) /\ (euclidean__axioms.Cong C E B C)) as H4.
--- apply (@lemma__extension.lemma__extension (B) (C) (B) (C) (H3) H3).
--- assert (exists E: euclidean__axioms.Point, ((euclidean__axioms.BetS B C E) /\ (euclidean__axioms.Cong C E B C))) as H5.
---- exact H4.
---- destruct H5 as [E H5].
assert (* AndElim *) ((euclidean__axioms.BetS B C E) /\ (euclidean__axioms.Cong C E B C)) as H6.
----- exact H5.
----- destruct H6 as [H6 H7].
...
-------- assert (* AndElim *) ((euclidean__axioms.neq C E) /\ ((euclidean__axioms.neq B C) /\ (euclidean__axioms.neq B E))) as H10.
--------- exact H9.
--------- destruct H10 as [H10 H11].
assert (* AndElim *) ((euclidean__axioms.neq B C) /\ (euclidean__axioms.neq B E)) as H12.
---------- exact H11.
---------- destruct H12 as [H12 H13].
exact H10.
...
-------------- assert (* AndElim *) ((euclidean__axioms.neq B C) /\ ((euclidean__axioms.neq C D) /\ ((euclidean__axioms.neq B D) /\ ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq D C) /\ (euclidean__axioms.neq D B)))))) as H16.
--------------- exact H15.
--------------- destruct H16 as [H16 H17].
assert (* AndElim *) ((euclidean__axioms.neq C D) /\ ((euclidean__axioms.neq B D) /\ ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq D C) /\ (euclidean__axioms.neq D B))))) as H18.
---------------- exact H17.
---------------- destruct H18 as [H18 H19].
assert (* AndElim *) ((euclidean__axioms.neq B D) /\ ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq D C) /\ (euclidean__axioms.neq D B)))) as H20.
----------------- exact H19.
----------------- destruct H20 as [H20 H21].
assert (* AndElim *) ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq D C) /\ (euclidean__axioms.neq D B))) as H22.
------------------ exact H21.
------------------ destruct H22 as [H22 H23].
assert (* AndElim *) ((euclidean__axioms.neq D C) /\ (euclidean__axioms.neq D B)) as H24.
------------------- exact H23.
...
---------------------- assert (* AndElim *) ((euclidean__defs.Par D C B A) /\ ((euclidean__defs.Par C D A B) /\ (euclidean__defs.Par D C A B))) as H24.
----------------------- exact H23.
----------------------- destruct H24 as [H24 H25].
assert (* AndElim *) ((euclidean__defs.Par C D A B) /\ (euclidean__defs.Par D C A B)) as H26.
------------------------ exact H25.
