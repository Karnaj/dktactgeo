...
Definition lemma__subtractequals : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (D: euclidean__axioms.Point) (E: euclidean__axioms.Point), (euclidean__axioms.BetS A B C) -> ((euclidean__axioms.BetS A D E) -> ((euclidean__axioms.Cong B C D E) -> ((euclidean__axioms.BetS A C E) -> (euclidean__axioms.BetS A B D)))).
Proof.
intro A.
intro B.
intro C.
...
-- assert (* Cut *) (euclidean__axioms.BetS A D C) as H5.
--- exact H4.
...
------ apply (@eq__ind__r euclidean__axioms.Point D (fun B0: euclidean__axioms.Point => (euclidean__axioms.BetS A B0 C) -> ((euclidean__axioms.Cong B0 C D E) -> ((~(euclidean__axioms.BetS A D B0)) -> ((~(euclidean__axioms.BetS A B0 D)) -> ((euclidean__axioms.BetS A B0 E) -> ((euclidean__axioms.Cong A B0 A B0) -> (euclidean__axioms.Cong A B0 A D)))))))) with (x := B).
-------intro H8.
intro H9.
intro H10.
intro H11.
...
-------------- assert (* AndElim *) ((euclidean__axioms.neq C E) /\ ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A E))) as H16.
--------------- exact H15.
--------------- destruct H16 as [H16 H17].
assert (* AndElim *) ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A E)) as H18.
---------------- exact H17.
