...
intro H1.
intro H2.
assert (exists N, (euclidean__axioms.BetS D N A) /\ ((euclidean__axioms.Col C B N) /\ (euclidean__axioms.nCol C B D))) as H3 by exact H2.
destruct H3 as [N H4].
...
exact H14.
--- assert (euclidean__axioms.nCol A B C) as H12 by exact H.
...
------- assert (exists q, (euclidean__axioms.BetS D q A) /\ ((euclidean__axioms.Col C B q) /\ (euclidean__axioms.nCol C B D))) as H17 by exact H2.
destruct H17 as [q H18].
...
---------- assert (exists U V u v X, (euclidean__axioms.neq B C) /\ ((euclidean__axioms.neq E D) /\ ((euclidean__axioms.Col B C U) /\ ((euclidean__axioms.Col B C V) /\ ((euclidean__axioms.neq U V) /\ ((euclidean__axioms.Col E D u) /\ ((euclidean__axioms.Col E D v) /\ ((euclidean__axioms.neq u v) /\ ((~(euclidean__defs.Meet B C E D)) /\ ((euclidean__axioms.BetS U X v) /\ (euclidean__axioms.BetS u X V))))))))))) as H25 by exact H24.
assert (exists U V u v X, (euclidean__axioms.neq B C) /\ ((euclidean__axioms.neq E D) /\ ((euclidean__axioms.Col B C U) /\ ((euclidean__axioms.Col B C V) /\ ((euclidean__axioms.neq U V) /\ ((euclidean__axioms.Col E D u) /\ ((euclidean__axioms.Col E D v) /\ ((euclidean__axioms.neq u v) /\ ((~(euclidean__defs.Meet B C E D)) /\ ((euclidean__axioms.BetS U X v) /\ (euclidean__axioms.BetS u X V))))))))))) as __TmpHyp by exact H25.
destruct __TmpHyp as [x H26].
destruct H26 as [x0 H27].
destruct H27 as [x1 H28].
destruct H28 as [x2 H29].
destruct H29 as [x3 H30].
...
---------------------------- exact H38.
------------------------- apply (@H25 H40).
------------ assert (* Cut *) (exists L, euclidean__defs.Perp__at A L D E L) as H28.
------------- apply (@proposition__12.proposition__12 D E A).
--------------apply (@euclidean__tactics.nCol__notCol D E A H27).

------------- destruct H28 as [L H29].
assert (exists p, (euclidean__axioms.Col A L L) /\ ((euclidean__axioms.Col D E L) /\ ((euclidean__axioms.Col D E p) /\ (euclidean__defs.Per p L A)))) as H30 by exact H29.
...
------------------------------------------- assert (exists M, (euclidean__axioms.BetS L M A) /\ ((euclidean__axioms.Col B C M) /\ (euclidean__axioms.nCol B C L))) as H68 by exact H67.
destruct H68 as [M H69].
destruct H69 as [H70 H71].
destruct H71 as [H72 H73].
...
exact H16.
-------------------------------------------- assert (euclidean__axioms.neq E D) as H75 by exact H15.
...
destruct H62 as [H102 H103].
destruct H103 as [H104 H105].
destruct H105 as [H106 H107].
destruct H47 as [H108 H109].
destruct H109 as [H110 H111].
destruct H111 as [H112 H113].
exact H101.
----------------------------------------------------------------- assert (euclidean__defs.Par B M L D) as H97 by exact H92.
...
---------------------------------------------------------------------------- assert (* Cut *) (forall B0 D0 E0 G H108, (euclidean__defs.Par G B0 H108 D0) -> ((euclidean__defs.OS B0 D0 G H108) -> ((euclidean__axioms.BetS E0 G H108) -> (euclidean__defs.CongA E0 G B0 G H108 D0)))) as H108.
----------------------------------------------------------------------------- intro B0.
intro D0.
intro E0.
intro G.
...
----------------------------------------------------------------------------------- apply (@eq__ind__r euclidean__axioms.Point C (fun M0 => (euclidean__axioms.BetS L M0 A) -> ((euclidean__axioms.Col B C M0) -> ((euclidean__axioms.neq L M0) -> ((euclidean__defs.Out L M0 A) -> ((euclidean__defs.Out L A M0) -> ((euclidean__defs.Per D L M0) -> ((~(B = M0)) -> ((euclidean__axioms.neq M0 B) -> ((euclidean__axioms.Col C B M0) -> ((euclidean__defs.Par L D M0 B) -> ((euclidean__defs.Par L D B M0) -> ((euclidean__defs.Par B M0 L D) -> ((euclidean__defs.Par B M0 D L) -> ((euclidean__defs.Par D L B M0) -> ((euclidean__defs.TP D L B M0) -> ((euclidean__defs.OS B M0 D L) -> ((euclidean__defs.Par B M0 L D) -> ((euclidean__defs.Par B D L M0) -> ((euclidean__defs.Par B D M0 L) -> ((euclidean__defs.PG B M0 L D) -> ((euclidean__defs.Par M0 L B D) -> ((euclidean__defs.TP M0 L B D) -> ((euclidean__defs.OS B D M0 L) -> ((euclidean__axioms.BetS A M0 L) -> ((euclidean__defs.Par M0 B L D) -> ((euclidean__defs.CongA A M0 B M0 L D) -> ((euclidean__defs.Per M0 L D) -> ((euclidean__defs.Per A M0 B) -> ((euclidean__axioms.BetS B M0 C) -> (euclidean__defs.Per A C B))))))))))))))))))))))))))))))) with (x := M).
------------------------------------------------------------------------------------intro H115.
intro H116.
intro H117.
intro H118.
...
------------------------------------------------------------------------------------ destruct H102 as [H116 H117].
destruct H23 as [H118 H119].
exact H119.
