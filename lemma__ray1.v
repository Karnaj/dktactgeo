...
Definition lemma__ray1 : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (P: euclidean__axioms.Point), (euclidean__defs.Out A B P) -> ((euclidean__axioms.BetS A P B) \/ ((B = P) \/ (euclidean__axioms.BetS A B P))).
Proof.
intro A.
intro B.
intro P.
