...
Definition lemma__lessthancongruence : forall A B C D E F, (euclidean__defs.Lt A B C D) -> ((euclidean__axioms.Cong C D E F) -> (euclidean__defs.Lt A B E F)).
Proof.
intro A.
intro B.
intro C.
...
---- apply (@H6 H8).
--- assert (* Cut *) (exists P, (euclidean__axioms.BetS F E P) /\ (euclidean__axioms.Cong E P F E)) as H8.
...
-------- assert (* Cut *) (exists H16, (euclidean__axioms.BetS P E H16) /\ (euclidean__axioms.Cong E H16 A B)) as H16.
...
----------- apply (@eq__ind__r euclidean__axioms.Point C (fun D0 => (euclidean__defs.Lt A B C D0) -> ((euclidean__axioms.Cong C D0 E F) -> ((euclidean__axioms.BetS C G D0) -> ((euclidean__axioms.neq C D0) -> (euclidean__axioms.BetS C G C)))))) with (x := D).
------------intro H22.
intro H23.
intro H24.
intro H25.
...
------------ assert (* Cut *) (exists Q, (euclidean__axioms.BetS D C Q) /\ (euclidean__axioms.Cong C Q E P)) as H24.
