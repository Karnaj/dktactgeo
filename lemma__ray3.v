...
Definition lemma__ray3 : forall (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (D: euclidean__axioms.Point) (V: euclidean__axioms.Point), (euclidean__defs.Out B C D) -> ((euclidean__defs.Out B C V) -> (euclidean__defs.Out B D V)).
Proof.
intro B.
intro C.
intro D.
...
intro H.
intro H0.
assert (* Cut *) (exists (E: euclidean__axioms.Point), (euclidean__axioms.BetS E B D) /\ (euclidean__axioms.BetS E B C)) as H1.
- exact H.
- assert (exists E: euclidean__axioms.Point, ((euclidean__axioms.BetS E B D) /\ (euclidean__axioms.BetS E B C))) as H2.
-- exact H1.
-- destruct H2 as [E H2].
assert (* AndElim *) ((euclidean__axioms.BetS E B D) /\ (euclidean__axioms.BetS E B C)) as H3.
--- exact H2.
--- destruct H3 as [H3 H4].
assert (* Cut *) (exists (H5: euclidean__axioms.Point), (euclidean__axioms.BetS H5 B V) /\ (euclidean__axioms.BetS H5 B C)) as H5.
---- exact H0.
---- assert (exists H6: euclidean__axioms.Point, ((euclidean__axioms.BetS H6 B V) /\ (euclidean__axioms.BetS H6 B C))) as H7.
----- exact H5.
----- destruct H7 as [H6 H7].
assert (* AndElim *) ((euclidean__axioms.BetS H6 B V) /\ (euclidean__axioms.BetS H6 B C)) as H8.
------ exact H7.
...
------------- apply (@eq__ind__r euclidean__axioms.Point E (fun H16: euclidean__axioms.Point => (euclidean__axioms.BetS H16 B V) -> ((euclidean__axioms.BetS H16 B C) -> ((~(euclidean__axioms.BetS B E H16)) -> ((~(euclidean__axioms.BetS B H16 E)) -> ((euclidean__axioms.BetS C B H16) -> (euclidean__axioms.BetS E B V))))))) with (x := H6).
--------------intro H16.
intro H17.
intro H18.
intro H19.
