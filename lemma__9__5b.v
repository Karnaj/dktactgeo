...
Definition lemma__9__5b : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (P: euclidean__axioms.Point) (Q: euclidean__axioms.Point) (R: euclidean__axioms.Point), (euclidean__axioms.TS P A B C) -> ((euclidean__axioms.BetS R Q P) -> ((euclidean__axioms.nCol C P R) -> ((euclidean__axioms.Col A B R) -> (euclidean__axioms.TS Q A B C)))).
Proof.
intro A.
intro B.
intro C.
...
----- assert (* Cut *) (exists (F: euclidean__axioms.Point), (euclidean__axioms.BetS C F Q) /\ (euclidean__axioms.BetS R F S)) as H10.
------ apply (@euclidean__axioms.postulate__Pasch__inner (C) (R) (P) (S) (Q) (H9) (H0) H1).
------ assert (exists F: euclidean__axioms.Point, ((euclidean__axioms.BetS C F Q) /\ (euclidean__axioms.BetS R F S))) as H11.
------- exact H10.
------- destruct H11 as [F H11].
assert (* AndElim *) ((euclidean__axioms.BetS C F Q) /\ (euclidean__axioms.BetS R F S)) as H12.
-------- exact H11.
...
--------------- assert (* AndElim *) ((euclidean__axioms.neq F S) /\ ((euclidean__axioms.neq R F) /\ (euclidean__axioms.neq R S))) as H20.
---------------- exact H19.
---------------- destruct H20 as [H20 H21].
assert (* AndElim *) ((euclidean__axioms.neq R F) /\ (euclidean__axioms.neq R S)) as H22.
----------------- exact H21.
...
-------------------------- apply (@eq__ind__r euclidean__axioms.Point B (fun S0: euclidean__axioms.Point => (euclidean__axioms.BetS P S0 C) -> ((euclidean__axioms.Col A B S0) -> ((euclidean__axioms.BetS C S0 P) -> ((euclidean__axioms.BetS R F S0) -> ((euclidean__axioms.Col R S0 F) -> ((euclidean__axioms.Col B R S0) -> ((euclidean__axioms.Col R S0 B) -> ((euclidean__axioms.neq R S0) -> ((euclidean__axioms.Col S0 F B) -> ((euclidean__axioms.Col S0 B A) -> ((euclidean__axioms.Col S0 B F) -> ((euclidean__axioms.Col B A S0) -> ((euclidean__axioms.Col R S0 F) -> (euclidean__axioms.Col R B F))))))))))))))) with (x := S).
---------------------------intro H28.
intro H29.
intro H30.
intro H31.
...
------------------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (R) (F) (S) H13).
------------------------------- assert (* AndElim *) ((euclidean__axioms.neq F S) /\ ((euclidean__axioms.neq R F) /\ (euclidean__axioms.neq R S))) as H33.
-------------------------------- exact H32.
-------------------------------- destruct H33 as [H33 H34].
assert (* AndElim *) ((euclidean__axioms.neq R F) /\ (euclidean__axioms.neq R S)) as H35.
--------------------------------- exact H34.
--------------------------------- destruct H35 as [H35 H36].
exact H19.
------------------------------ assert (* Cut *) (euclidean__axioms.neq R B) as H33.
------------------------------- apply (@eq__ind__r euclidean__axioms.Point B (fun R0: euclidean__axioms.Point => (euclidean__axioms.BetS R0 Q P) -> ((euclidean__axioms.nCol C P R0) -> ((euclidean__axioms.Col A B R0) -> ((euclidean__axioms.BetS R0 F S) -> ((euclidean__axioms.Col R0 S F) -> ((euclidean__axioms.Col B R0 S) -> ((euclidean__axioms.Col R0 S B) -> ((euclidean__axioms.neq R0 S) -> ((euclidean__axioms.Col R0 S F) -> ((euclidean__axioms.Col R0 B F) -> ((euclidean__axioms.Col R0 B A) -> ((R0 = S) -> ((euclidean__axioms.neq R0 S) -> (euclidean__axioms.neq R0 B))))))))))))))) with (x := R).
--------------------------------intro H33.
intro H34.
intro H35.
intro H36.
...
intro H44.
intro H45.
apply (@eq__ind__r euclidean__axioms.Point B (fun S0: euclidean__axioms.Point => (euclidean__axioms.BetS P S0 C) -> ((euclidean__axioms.Col A B S0) -> ((euclidean__axioms.BetS C S0 P) -> ((euclidean__axioms.Col B S0 F) -> ((euclidean__axioms.BetS B F S0) -> ((euclidean__axioms.neq B S0) -> ((euclidean__axioms.Col B S0 B) -> ((euclidean__axioms.Col B B S0) -> ((euclidean__axioms.Col S0 F B) -> ((euclidean__axioms.Col S0 B A) -> ((euclidean__axioms.Col S0 B F) -> ((euclidean__axioms.Col B A S0) -> ((euclidean__axioms.Col B S0 F) -> ((euclidean__axioms.neq B S0) -> ((B = S0) -> (euclidean__axioms.neq B B))))))))))))))))) with (x := S).
---------------------------------intro H46.
intro H47.
intro H48.
intro H49.
...
-------------------------------- assert (* AndElim *) ((euclidean__axioms.Col Q R P) /\ ((euclidean__axioms.Col Q P R) /\ ((euclidean__axioms.Col P R Q) /\ ((euclidean__axioms.Col R P Q) /\ (euclidean__axioms.Col P Q R))))) as H37.
--------------------------------- exact H36.
--------------------------------- destruct H37 as [H37 H38].
assert (* AndElim *) ((euclidean__axioms.Col Q P R) /\ ((euclidean__axioms.Col P R Q) /\ ((euclidean__axioms.Col R P Q) /\ (euclidean__axioms.Col P Q R)))) as H39.
---------------------------------- exact H38.
---------------------------------- destruct H39 as [H39 H40].
assert (* AndElim *) ((euclidean__axioms.Col P R Q) /\ ((euclidean__axioms.Col R P Q) /\ (euclidean__axioms.Col P Q R))) as H41.
----------------------------------- exact H40.
----------------------------------- destruct H41 as [H41 H42].
assert (* AndElim *) ((euclidean__axioms.Col R P Q) /\ (euclidean__axioms.Col P Q R)) as H43.
------------------------------------ exact H42.
------------------------------------ destruct H43 as [H43 H44].
exact H33.
...
--------------------------------- apply (@lemma__collinearorder.lemma__collinearorder (R) (Q) (P) H35).
--------------------------------- assert (* AndElim *) ((euclidean__axioms.Col Q R P) /\ ((euclidean__axioms.Col Q P R) /\ ((euclidean__axioms.Col P R Q) /\ ((euclidean__axioms.Col R P Q) /\ (euclidean__axioms.Col P Q R))))) as H38.
---------------------------------- exact H37.
---------------------------------- destruct H38 as [H38 H39].
assert (* AndElim *) ((euclidean__axioms.Col Q P R) /\ ((euclidean__axioms.Col P R Q) /\ ((euclidean__axioms.Col R P Q) /\ (euclidean__axioms.Col P Q R)))) as H40.
----------------------------------- exact H39.
----------------------------------- destruct H40 as [H40 H41].
assert (* AndElim *) ((euclidean__axioms.Col P R Q) /\ ((euclidean__axioms.Col R P Q) /\ (euclidean__axioms.Col P Q R))) as H42.
------------------------------------ exact H41.
------------------------------------ destruct H42 as [H42 H43].
assert (* AndElim *) ((euclidean__axioms.Col R P Q) /\ (euclidean__axioms.Col P Q R)) as H44.
------------------------------------- exact H43.
------------------------------------- destruct H44 as [H44 H45].
exact H38.
...
---------------------------------- assert (* AndElim *) ((euclidean__axioms.neq Q P) /\ ((euclidean__axioms.neq R Q) /\ (euclidean__axioms.neq R P))) as H39.
----------------------------------- exact H38.
----------------------------------- destruct H39 as [H39 H40].
assert (* AndElim *) ((euclidean__axioms.neq R Q) /\ (euclidean__axioms.neq R P)) as H41.
------------------------------------ exact H40.
------------------------------------ destruct H41 as [H41 H42].
exact H41.
...
------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col C R P) /\ ((euclidean__axioms.Col C P R) /\ ((euclidean__axioms.Col P R C) /\ ((euclidean__axioms.Col R P C) /\ (euclidean__axioms.Col P C R))))) as H42.
-------------------------------------- exact H41.
-------------------------------------- destruct H42 as [H42 H43].
assert (* AndElim *) ((euclidean__axioms.Col C P R) /\ ((euclidean__axioms.Col P R C) /\ ((euclidean__axioms.Col R P C) /\ (euclidean__axioms.Col P C R)))) as H44.
--------------------------------------- exact H43.
--------------------------------------- destruct H44 as [H44 H45].
assert (* AndElim *) ((euclidean__axioms.Col P R C) /\ ((euclidean__axioms.Col R P C) /\ (euclidean__axioms.Col P C R))) as H46.
---------------------------------------- exact H45.
---------------------------------------- destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Col R P C) /\ (euclidean__axioms.Col P C R)) as H48.
----------------------------------------- exact H47.
