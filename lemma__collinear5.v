...
Definition lemma__collinear5 : forall A B C D E, (euclidean__axioms.neq A B) -> ((euclidean__axioms.Col A B C) -> ((euclidean__axioms.Col A B D) -> ((euclidean__axioms.Col A B E) -> (euclidean__axioms.Col C D E)))).
Proof.
intro A.
intro B.
intro C.
...
---- assert ((euclidean__axioms.neq B C) \/ (B = C)) as H6 by exact H5.
assert ((euclidean__axioms.neq B C) \/ (B = C)) as __TmpHyp by exact H6.
...
------- apply (@eq__ind__r euclidean__axioms.Point C (fun B0 => (euclidean__axioms.neq A B0) -> ((euclidean__axioms.Col A B0 C) -> ((euclidean__axioms.Col A B0 D) -> ((euclidean__axioms.Col A B0 E) -> ((euclidean__axioms.Col B0 C D) -> ((euclidean__axioms.Col B0 C E) -> ((euclidean__axioms.Col B0 D E) -> (euclidean__axioms.Col C D E))))))))) with (x := B).
--------intro H9.
intro H10.
intro H11.
intro H12.
