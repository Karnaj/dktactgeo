...
Definition lemma__lessthanadditive : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (D: euclidean__axioms.Point) (E: euclidean__axioms.Point) (F: euclidean__axioms.Point), (euclidean__defs.Lt A B C D) -> ((euclidean__axioms.BetS A B E) -> ((euclidean__axioms.BetS C D F) -> ((euclidean__axioms.Cong B E D F) -> (euclidean__defs.Lt A E C F)))).
Proof.
intro A.
intro B.
intro C.
...
intro H1.
intro H2.
assert (* Cut *) (exists (b: euclidean__axioms.Point), (euclidean__axioms.BetS C b D) /\ (euclidean__axioms.Cong C b A B)) as H3.
- exact H.
- assert (exists b: euclidean__axioms.Point, ((euclidean__axioms.BetS C b D) /\ (euclidean__axioms.Cong C b A B))) as H4.
-- exact H3.
-- destruct H4 as [b H4].
assert (* AndElim *) ((euclidean__axioms.BetS C b D) /\ (euclidean__axioms.Cong C b A B)) as H5.
--- exact H4.
...
------ assert (* AndElim *) ((euclidean__axioms.neq b D) /\ ((euclidean__axioms.neq C b) /\ (euclidean__axioms.neq C D))) as H9.
------- exact H8.
------- destruct H9 as [H9 H10].
assert (* AndElim *) ((euclidean__axioms.neq C b) /\ (euclidean__axioms.neq C D)) as H11.
-------- exact H10.
...
-------- assert (* AndElim *) ((euclidean__axioms.neq B E) /\ ((euclidean__axioms.neq A B) /\ (euclidean__axioms.neq A E))) as H11.
--------- exact H10.
--------- destruct H11 as [H11 H12].
assert (* AndElim *) ((euclidean__axioms.neq A B) /\ (euclidean__axioms.neq A E)) as H13.
---------- exact H12.
---------- destruct H13 as [H13 H14].
exact H11.
------- assert (* Cut *) (exists (e: euclidean__axioms.Point), (euclidean__axioms.BetS C b e) /\ (euclidean__axioms.Cong b e B E)) as H11.
-------- apply (@lemma__extension.lemma__extension (C) (b) (B) (E) (H8) H10).
-------- assert (exists e: euclidean__axioms.Point, ((euclidean__axioms.BetS C b e) /\ (euclidean__axioms.Cong b e B E))) as H12.
--------- exact H11.
--------- destruct H12 as [e H12].
assert (* AndElim *) ((euclidean__axioms.BetS C b e) /\ (euclidean__axioms.Cong b e B E)) as H13.
---------- exact H12.
---------- destruct H13 as [H13 H14].
...
----------------------------- assert (* Cut *) (exists (q: euclidean__axioms.Point), (euclidean__axioms.BetS b q F) /\ (euclidean__axioms.Cong b q b e)) as H34.
------------------------------ exact H33.
------------------------------ assert (exists q: euclidean__axioms.Point, ((euclidean__axioms.BetS b q F) /\ (euclidean__axioms.Cong b q b e))) as H35.
------------------------------- exact H34.
------------------------------- destruct H35 as [q H35].
assert (* AndElim *) ((euclidean__axioms.BetS b q F) /\ (euclidean__axioms.Cong b q b e)) as H36.
-------------------------------- exact H35.
...
---------------------------------- assert (* AndElim *) ((euclidean__axioms.neq q F) /\ ((euclidean__axioms.neq b q) /\ (euclidean__axioms.neq b F))) as H39.
----------------------------------- exact H38.
----------------------------------- destruct H39 as [H39 H40].
assert (* AndElim *) ((euclidean__axioms.neq b q) /\ (euclidean__axioms.neq b F)) as H41.
------------------------------------ exact H40.
...
----------------------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (b) (q) (F) H36).
----------------------------------- assert (* AndElim *) ((euclidean__axioms.neq q F) /\ ((euclidean__axioms.neq b q) /\ (euclidean__axioms.neq b F))) as H40.
------------------------------------ exact H39.
------------------------------------ destruct H40 as [H40 H41].
assert (* AndElim *) ((euclidean__axioms.neq b q) /\ (euclidean__axioms.neq b F)) as H42.
------------------------------------- exact H41.
...
-------------------------------------- apply (@eq__ind__r euclidean__axioms.Point e (fun q0: euclidean__axioms.Point => (euclidean__axioms.BetS b q0 F) -> ((euclidean__axioms.Cong b q0 b e) -> ((euclidean__axioms.neq b q0) -> ((euclidean__defs.Out b F q0) -> (euclidean__axioms.BetS b e F)))))) with (x := q).
---------------------------------------intro H43.
intro H44.
intro H45.
intro H46.
...
------------------ apply (@eq__ind__r euclidean__axioms.Point e (fun F0: euclidean__axioms.Point => (euclidean__axioms.BetS C D F0) -> ((euclidean__axioms.Cong B E D F0) -> ((euclidean__axioms.BetS C b F0) -> ((~(euclidean__axioms.BetS b F0 e)) -> (euclidean__axioms.Cong b F0 B E)))))) with (x := F).
-------------------intro H22.
intro H23.
intro H24.
intro H25.
...
--------------------------- assert (* AndElim *) ((euclidean__axioms.Cong F D E B) /\ ((euclidean__axioms.Cong F D B E) /\ (euclidean__axioms.Cong D F E B))) as H31.
---------------------------- exact H30.
---------------------------- destruct H31 as [H31 H32].
assert (* AndElim *) ((euclidean__axioms.Cong F D B E) /\ (euclidean__axioms.Cong D F E B)) as H33.
----------------------------- exact H32.
