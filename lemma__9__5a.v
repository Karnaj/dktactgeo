...
Definition lemma__9__5a : forall A B C P Q R, (euclidean__axioms.TS P A B C) -> ((euclidean__axioms.BetS R P Q) -> ((euclidean__axioms.nCol R Q C) -> ((euclidean__axioms.Col A B R) -> (euclidean__axioms.TS Q A B C)))).
Proof.
intro A.
intro B.
intro C.
...
- assert (* Cut *) (exists F, (euclidean__axioms.BetS C F Q) /\ (euclidean__axioms.BetS R S F)) as H10.
...
---------------- apply (@eq__ind__r euclidean__axioms.Point B (fun S0 => (euclidean__axioms.BetS P S0 C) -> ((euclidean__axioms.Col A B S0) -> ((euclidean__axioms.BetS C S0 P) -> ((euclidean__axioms.BetS R S0 F) -> ((euclidean__axioms.Col R S0 F) -> ((euclidean__axioms.Col B R S0) -> ((euclidean__axioms.Col R S0 B) -> ((euclidean__axioms.neq R S0) -> ((euclidean__axioms.Col S0 F B) -> ((euclidean__axioms.Col S0 B A) -> ((euclidean__axioms.Col S0 B F) -> ((euclidean__axioms.Col B A S0) -> ((euclidean__axioms.Col R S0 F) -> (euclidean__axioms.Col R B F))))))))))))))) with (x := S).
-----------------intro H28.
intro H29.
intro H30.
intro H31.
...
--------------------- apply (@eq__ind__r euclidean__axioms.Point B (fun R0 => (euclidean__axioms.BetS R0 P Q) -> ((euclidean__axioms.nCol R0 Q C) -> ((euclidean__axioms.Col A B R0) -> ((euclidean__axioms.BetS R0 S F) -> ((euclidean__axioms.Col R0 S F) -> ((euclidean__axioms.Col B R0 S) -> ((euclidean__axioms.Col R0 S B) -> ((euclidean__axioms.neq R0 S) -> ((euclidean__axioms.Col R0 S F) -> ((euclidean__axioms.Col R0 B F) -> ((euclidean__axioms.Col R0 B A) -> ((R0 = S) -> ((euclidean__axioms.neq R0 S) -> (euclidean__axioms.neq R0 B))))))))))))))) with (x := R).
----------------------intro H33.
intro H34.
intro H35.
intro H36.
...
intro H44.
intro H45.
apply (@eq__ind__r euclidean__axioms.Point B (fun S0 => (euclidean__axioms.BetS P S0 C) -> ((euclidean__axioms.Col A B S0) -> ((euclidean__axioms.BetS C S0 P) -> ((euclidean__axioms.Col B S0 F) -> ((euclidean__axioms.BetS B S0 F) -> ((euclidean__axioms.neq B S0) -> ((euclidean__axioms.Col B S0 B) -> ((euclidean__axioms.Col B B S0) -> ((euclidean__axioms.Col S0 F B) -> ((euclidean__axioms.Col S0 B A) -> ((euclidean__axioms.Col S0 B F) -> ((euclidean__axioms.Col B A S0) -> ((euclidean__axioms.Col B S0 F) -> ((euclidean__axioms.neq B S0) -> ((B = S0) -> (euclidean__axioms.neq B B))))))))))))))))) with (x := S).
-----------------------intro H46.
intro H47.
intro H48.
intro H49.
