...
Definition proposition__12 : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point), (euclidean__axioms.nCol A B C) -> (exists (X: euclidean__axioms.Point), euclidean__defs.Perp__at C X A B X).
Proof.
intro A.
intro B.
intro C.
...
--- assert (* Cut *) (exists (E: euclidean__axioms.Point), (euclidean__axioms.BetS C B E) /\ (euclidean__axioms.Cong B E C B)) as H3.
---- apply (@lemma__extension.lemma__extension (C) (B) (C) (B) (H1) H1).
---- assert (exists E: euclidean__axioms.Point, ((euclidean__axioms.BetS C B E) /\ (euclidean__axioms.Cong B E C B))) as H4.
----- exact H3.
----- destruct H4 as [E H4].
assert (* AndElim *) ((euclidean__axioms.BetS C B E) /\ (euclidean__axioms.Cong B E C B)) as H5.
------ exact H4.
...
-------- assert (* AndElim *) ((euclidean__axioms.neq B E) /\ ((euclidean__axioms.neq C B) /\ (euclidean__axioms.neq C E))) as H8.
--------- exact H7.
--------- destruct H8 as [H8 H9].
assert (* AndElim *) ((euclidean__axioms.neq C B) /\ (euclidean__axioms.neq C E)) as H10.
---------- exact H9.
---------- destruct H10 as [H10 H11].
exact H11.
------- assert (* Cut *) (euclidean__axioms.neq E C) as H8.
-------- apply (@lemma__inequalitysymmetric.lemma__inequalitysymmetric (C) (E) H7).
-------- assert (* Cut *) (exists (F: euclidean__axioms.Point), (euclidean__axioms.BetS E C F) /\ (euclidean__axioms.Cong C F E C)) as H9.
--------- apply (@lemma__extension.lemma__extension (E) (C) (E) (C) (H8) H8).
--------- assert (exists F: euclidean__axioms.Point, ((euclidean__axioms.BetS E C F) /\ (euclidean__axioms.Cong C F E C))) as H10.
---------- exact H9.
---------- destruct H10 as [F H10].
assert (* AndElim *) ((euclidean__axioms.BetS E C F) /\ (euclidean__axioms.Cong C F E C)) as H11.
----------- exact H10.
...
---------------- assert (* Cut *) (exists (K: euclidean__axioms.Circle), euclidean__axioms.CI K C C E) as H18.
----------------- apply (@euclidean__axioms.postulate__Euclid3 (C) (E) H7).
----------------- assert (exists K: euclidean__axioms.Circle, (euclidean__axioms.CI K C C E)) as H19.
------------------ exact H18.
------------------ destruct H19 as [K H19].
assert (* Cut *) (euclidean__axioms.Cong C E C E) as H20.
------------------- exact H14.
...
------------------------ exact H20.
------------------------ exact H21.
--------------------- assert (* Cut *) (exists (P: euclidean__axioms.Point) (Q: euclidean__axioms.Point), (euclidean__axioms.Col A B P) /\ ((euclidean__axioms.BetS A B Q) /\ ((euclidean__axioms.OnCirc P K) /\ ((euclidean__axioms.OnCirc Q K) /\ (euclidean__axioms.BetS P B Q))))) as H23.
---------------------- apply (@euclidean__axioms.postulate__line__circle (A) (B) (C) (K) (C) (E) (H19) (H22) H2).
---------------------- assert (exists P: euclidean__axioms.Point, (exists (Q: euclidean__axioms.Point), (euclidean__axioms.Col A B P) /\ ((euclidean__axioms.BetS A B Q) /\ ((euclidean__axioms.OnCirc P K) /\ ((euclidean__axioms.OnCirc Q K) /\ (euclidean__axioms.BetS P B Q)))))) as H24.
----------------------- exact H23.
----------------------- destruct H24 as [P H24].
assert (exists Q: euclidean__axioms.Point, ((euclidean__axioms.Col A B P) /\ ((euclidean__axioms.BetS A B Q) /\ ((euclidean__axioms.OnCirc P K) /\ ((euclidean__axioms.OnCirc Q K) /\ (euclidean__axioms.BetS P B Q)))))) as H25.
------------------------ exact H24.
------------------------ destruct H25 as [Q H25].
assert (* AndElim *) ((euclidean__axioms.Col A B P) /\ ((euclidean__axioms.BetS A B Q) /\ ((euclidean__axioms.OnCirc P K) /\ ((euclidean__axioms.OnCirc Q K) /\ (euclidean__axioms.BetS P B Q))))) as H26.
------------------------- exact H25.
------------------------- destruct H26 as [H26 H27].
assert (* AndElim *) ((euclidean__axioms.BetS A B Q) /\ ((euclidean__axioms.OnCirc P K) /\ ((euclidean__axioms.OnCirc Q K) /\ (euclidean__axioms.BetS P B Q)))) as H28.
-------------------------- exact H27.
-------------------------- destruct H28 as [H28 H29].
assert (* AndElim *) ((euclidean__axioms.OnCirc P K) /\ ((euclidean__axioms.OnCirc Q K) /\ (euclidean__axioms.BetS P B Q))) as H30.
--------------------------- exact H29.
--------------------------- destruct H30 as [H30 H31].
assert (* AndElim *) ((euclidean__axioms.OnCirc Q K) /\ (euclidean__axioms.BetS P B Q)) as H32.
---------------------------- exact H31.
...
----------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong P C Q C) /\ ((euclidean__axioms.Cong P C C Q) /\ (euclidean__axioms.Cong C P Q C))) as H40.
------------------------------------ exact H39.
------------------------------------ destruct H40 as [H40 H41].
assert (* AndElim *) ((euclidean__axioms.Cong P C C Q) /\ (euclidean__axioms.Cong C P Q C)) as H42.
------------------------------------- exact H41.
...
------------------------------------ assert (* AndElim *) ((euclidean__axioms.neq B Q) /\ ((euclidean__axioms.neq P B) /\ (euclidean__axioms.neq P Q))) as H41.
------------------------------------- exact H40.
------------------------------------- destruct H41 as [H41 H42].
assert (* AndElim *) ((euclidean__axioms.neq P B) /\ (euclidean__axioms.neq P Q)) as H43.
-------------------------------------- exact H42.
-------------------------------------- destruct H43 as [H43 H44].
exact H44.
----------------------------------- assert (* Cut *) (exists (M: euclidean__axioms.Point), (euclidean__axioms.BetS P M Q) /\ (euclidean__axioms.Cong M P M Q)) as H41.
------------------------------------ apply (@proposition__10.proposition__10 (P) (Q) H40).
------------------------------------ assert (exists M: euclidean__axioms.Point, ((euclidean__axioms.BetS P M Q) /\ (euclidean__axioms.Cong M P M Q))) as H42.
------------------------------------- exact H41.
------------------------------------- destruct H42 as [M H42].
assert (* AndElim *) ((euclidean__axioms.BetS P M Q) /\ (euclidean__axioms.Cong M P M Q)) as H43.
-------------------------------------- exact H42.
-------------------------------------- destruct H43 as [H43 H44].
...
---------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong P M Q M) /\ ((euclidean__axioms.Cong P M M Q) /\ (euclidean__axioms.Cong M P Q M))) as H46.
----------------------------------------- exact H45.
----------------------------------------- destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Cong P M M Q) /\ (euclidean__axioms.Cong M P Q M)) as H48.
------------------------------------------ exact H47.
...
------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col B P Q) /\ ((euclidean__axioms.Col B Q P) /\ ((euclidean__axioms.Col Q P B) /\ ((euclidean__axioms.Col P Q B) /\ (euclidean__axioms.Col Q B P))))) as H49.
-------------------------------------------- exact H48.
-------------------------------------------- destruct H49 as [H49 H50].
assert (* AndElim *) ((euclidean__axioms.Col B Q P) /\ ((euclidean__axioms.Col Q P B) /\ ((euclidean__axioms.Col P Q B) /\ (euclidean__axioms.Col Q B P)))) as H51.
--------------------------------------------- exact H50.
--------------------------------------------- destruct H51 as [H51 H52].
assert (* AndElim *) ((euclidean__axioms.Col Q P B) /\ ((euclidean__axioms.Col P Q B) /\ (euclidean__axioms.Col Q B P))) as H53.
---------------------------------------------- exact H52.
---------------------------------------------- destruct H53 as [H53 H54].
assert (* AndElim *) ((euclidean__axioms.Col P Q B) /\ (euclidean__axioms.Col Q B P)) as H55.
----------------------------------------------- exact H54.
...
-------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col M P Q) /\ ((euclidean__axioms.Col M Q P) /\ ((euclidean__axioms.Col Q P M) /\ ((euclidean__axioms.Col P Q M) /\ (euclidean__axioms.Col Q M P))))) as H50.
--------------------------------------------- exact H49.
--------------------------------------------- destruct H50 as [H50 H51].
assert (* AndElim *) ((euclidean__axioms.Col M Q P) /\ ((euclidean__axioms.Col Q P M) /\ ((euclidean__axioms.Col P Q M) /\ (euclidean__axioms.Col Q M P)))) as H52.
---------------------------------------------- exact H51.
---------------------------------------------- destruct H52 as [H52 H53].
assert (* AndElim *) ((euclidean__axioms.Col Q P M) /\ ((euclidean__axioms.Col P Q M) /\ (euclidean__axioms.Col Q M P))) as H54.
----------------------------------------------- exact H53.
----------------------------------------------- destruct H54 as [H54 H55].
assert (* AndElim *) ((euclidean__axioms.Col P Q M) /\ (euclidean__axioms.Col Q M P)) as H56.
------------------------------------------------ exact H55.
...
---------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col B A Q) /\ ((euclidean__axioms.Col B Q A) /\ ((euclidean__axioms.Col Q A B) /\ ((euclidean__axioms.Col A Q B) /\ (euclidean__axioms.Col Q B A))))) as H52.
----------------------------------------------- exact H51.
----------------------------------------------- destruct H52 as [H52 H53].
assert (* AndElim *) ((euclidean__axioms.Col B Q A) /\ ((euclidean__axioms.Col Q A B) /\ ((euclidean__axioms.Col A Q B) /\ (euclidean__axioms.Col Q B A)))) as H54.
------------------------------------------------ exact H53.
------------------------------------------------ destruct H54 as [H54 H55].
assert (* AndElim *) ((euclidean__axioms.Col Q A B) /\ ((euclidean__axioms.Col A Q B) /\ (euclidean__axioms.Col Q B A))) as H56.
------------------------------------------------- exact H55.
------------------------------------------------- destruct H56 as [H56 H57].
assert (* AndElim *) ((euclidean__axioms.Col A Q B) /\ (euclidean__axioms.Col Q B A)) as H58.
-------------------------------------------------- exact H57.
...
----------------------------------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (P) (B) (Q) H33).
----------------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq B Q) /\ ((euclidean__axioms.neq P B) /\ (euclidean__axioms.neq P Q))) as H53.
------------------------------------------------ exact H52.
------------------------------------------------ destruct H53 as [H53 H54].
assert (* AndElim *) ((euclidean__axioms.neq P B) /\ (euclidean__axioms.neq P Q)) as H55.
------------------------------------------------- exact H54.
------------------------------------------------- destruct H55 as [H55 H56].
exact H53.
...
--------------------------------------------------- apply (@eq__ind__r euclidean__axioms.Point C (fun M0: euclidean__axioms.Point => (euclidean__axioms.BetS P M0 Q) -> ((euclidean__axioms.Cong M0 P M0 Q) -> ((euclidean__axioms.Cong P M0 Q M0) -> ((euclidean__axioms.Col P M0 Q) -> ((euclidean__axioms.Col P Q M0) -> ((euclidean__axioms.Col Q B M0) -> ((euclidean__axioms.Col B M0 A) -> ((euclidean__axioms.Col A B M0) -> (euclidean__axioms.Col A B C)))))))))) with (x := M).
----------------------------------------------------intro H57.
intro H58.
intro H59.
intro H60.
