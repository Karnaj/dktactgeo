...
Definition lemma__notperp : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (P: euclidean__axioms.Point), (euclidean__axioms.BetS A C B) -> ((euclidean__axioms.nCol A B P) -> (exists (X: euclidean__axioms.Point), (euclidean__axioms.nCol A B X) /\ ((euclidean__defs.OS X P A B) /\ (~(euclidean__defs.Per A C X))))).
Proof.
intro A.
intro B.
intro C.
...
-- assert (* AndElim *) ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B))) as H2.
--- exact H1.
--- destruct H2 as [H2 H3].
assert (* AndElim *) ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B)) as H4.
---- exact H3.
...
---- apply (@eq__ind__r euclidean__axioms.Point P (fun C0: euclidean__axioms.Point => (euclidean__axioms.BetS A C0 B) -> ((euclidean__axioms.neq C0 B) -> ((euclidean__axioms.neq B C0) -> (euclidean__axioms.nCol A B C0))))) with (x := C).
-----intro H4.
intro H5.
intro H6.
exact H0.
...
------- assert (* AndElim *) ((euclidean__axioms.Col C A B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B A C) /\ ((euclidean__axioms.Col A B C) /\ (euclidean__axioms.Col B C A))))) as H7.
-------- exact H6.
-------- destruct H7 as [H7 H8].
assert (* AndElim *) ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B A C) /\ ((euclidean__axioms.Col A B C) /\ (euclidean__axioms.Col B C A)))) as H9.
--------- exact H8.
--------- destruct H9 as [H9 H10].
assert (* AndElim *) ((euclidean__axioms.Col B A C) /\ ((euclidean__axioms.Col A B C) /\ (euclidean__axioms.Col B C A))) as H11.
---------- exact H10.
---------- destruct H11 as [H11 H12].
assert (* AndElim *) ((euclidean__axioms.Col A B C) /\ (euclidean__axioms.Col B C A)) as H13.
----------- exact H12.
----------- destruct H13 as [H13 H14].
exact H13.
------ apply (@euclidean__tactics.Col__nCol__False (A) (B) (C) (H4) H6).
--- assert (* Cut *) (exists (Q: euclidean__axioms.Point), (euclidean__axioms.BetS B C Q) /\ (euclidean__axioms.Cong C Q C P)) as H4.
---- apply (@lemma__extension.lemma__extension (B) (C) (C) (P) (H2) H3).
---- assert (exists Q: euclidean__axioms.Point, ((euclidean__axioms.BetS B C Q) /\ (euclidean__axioms.Cong C Q C P))) as H5.
----- exact H4.
----- destruct H5 as [Q H5].
assert (* AndElim *) ((euclidean__axioms.BetS B C Q) /\ (euclidean__axioms.Cong C Q C P)) as H6.
------ exact H5.
...
--------- apply (@eq__ind__r euclidean__axioms.Point Q (fun P0: euclidean__axioms.Point => (euclidean__axioms.nCol A B P0) -> ((~(C = P0)) -> ((euclidean__axioms.Cong C Q C P0) -> (euclidean__axioms.Col B C P0))))) with (x := P).
----------intro H10.
intro H11.
intro H12.
exact H9.
...
------------- assert (* AndElim *) ((euclidean__axioms.Col C B P) /\ ((euclidean__axioms.Col C P B) /\ ((euclidean__axioms.Col P B C) /\ ((euclidean__axioms.Col B P C) /\ (euclidean__axioms.Col P C B))))) as H14.
-------------- exact H13.
-------------- destruct H14 as [H14 H15].
assert (* AndElim *) ((euclidean__axioms.Col C P B) /\ ((euclidean__axioms.Col P B C) /\ ((euclidean__axioms.Col B P C) /\ (euclidean__axioms.Col P C B)))) as H16.
--------------- exact H15.
--------------- destruct H16 as [H16 H17].
assert (* AndElim *) ((euclidean__axioms.Col P B C) /\ ((euclidean__axioms.Col B P C) /\ (euclidean__axioms.Col P C B))) as H18.
---------------- exact H17.
---------------- destruct H18 as [H18 H19].
assert (* AndElim *) ((euclidean__axioms.Col B P C) /\ (euclidean__axioms.Col P C B)) as H20.
----------------- exact H19.
...
--------------- assert (* AndElim *) ((euclidean__axioms.Col A B P) /\ ((euclidean__axioms.Col A P B) /\ ((euclidean__axioms.Col P B A) /\ ((euclidean__axioms.Col B P A) /\ (euclidean__axioms.Col P A B))))) as H16.
---------------- exact H15.
---------------- destruct H16 as [H16 H17].
assert (* AndElim *) ((euclidean__axioms.Col A P B) /\ ((euclidean__axioms.Col P B A) /\ ((euclidean__axioms.Col B P A) /\ (euclidean__axioms.Col P A B)))) as H18.
----------------- exact H17.
----------------- destruct H18 as [H18 H19].
assert (* AndElim *) ((euclidean__axioms.Col P B A) /\ ((euclidean__axioms.Col B P A) /\ (euclidean__axioms.Col P A B))) as H20.
------------------ exact H19.
------------------ destruct H20 as [H20 H21].
assert (* AndElim *) ((euclidean__axioms.Col B P A) /\ (euclidean__axioms.Col P A B)) as H22.
------------------- exact H21.
------------------- destruct H22 as [H22 H23].
exact H16.
-------------- apply (@euclidean__tactics.Col__nCol__False (A) (B) (P) (H0) H15).
------- assert (* Cut *) (exists (M: euclidean__axioms.Point), (euclidean__axioms.BetS P M Q) /\ (euclidean__axioms.Cong M P M Q)) as H9.
-------- apply (@proposition__10.proposition__10 (P) (Q) H8).
-------- assert (exists M: euclidean__axioms.Point, ((euclidean__axioms.BetS P M Q) /\ (euclidean__axioms.Cong M P M Q))) as H10.
--------- exact H9.
--------- destruct H10 as [M H10].
assert (* AndElim *) ((euclidean__axioms.BetS P M Q) /\ (euclidean__axioms.Cong M P M Q)) as H11.
---------- exact H10.
---------- destruct H11 as [H11 H12].
...
------------- assert (* AndElim *) ((euclidean__axioms.Col C A B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B A C) /\ ((euclidean__axioms.Col A B C) /\ (euclidean__axioms.Col B C A))))) as H15.
-------------- exact H14.
-------------- destruct H15 as [H15 H16].
assert (* AndElim *) ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B A C) /\ ((euclidean__axioms.Col A B C) /\ (euclidean__axioms.Col B C A)))) as H17.
--------------- exact H16.
--------------- destruct H17 as [H17 H18].
assert (* AndElim *) ((euclidean__axioms.Col B A C) /\ ((euclidean__axioms.Col A B C) /\ (euclidean__axioms.Col B C A))) as H19.
---------------- exact H18.
---------------- destruct H19 as [H19 H20].
assert (* AndElim *) ((euclidean__axioms.Col A B C) /\ (euclidean__axioms.Col B C A)) as H21.
----------------- exact H20.
...
-------------- assert (* AndElim *) ((euclidean__axioms.neq M Q) /\ ((euclidean__axioms.neq P M) /\ (euclidean__axioms.neq P Q))) as H16.
--------------- exact H15.
--------------- destruct H16 as [H16 H17].
assert (* AndElim *) ((euclidean__axioms.neq P M) /\ (euclidean__axioms.neq P Q)) as H18.
---------------- exact H17.
---------------- destruct H18 as [H18 H19].
exact H1.
...
----------------- assert (* AndElim *) ((euclidean__axioms.Col A B Q) /\ ((euclidean__axioms.Col A Q B) /\ ((euclidean__axioms.Col Q B A) /\ ((euclidean__axioms.Col B Q A) /\ (euclidean__axioms.Col Q A B))))) as H19.
------------------ exact H18.
------------------ destruct H19 as [H19 H20].
assert (* AndElim *) ((euclidean__axioms.Col A Q B) /\ ((euclidean__axioms.Col Q B A) /\ ((euclidean__axioms.Col B Q A) /\ (euclidean__axioms.Col Q A B)))) as H21.
------------------- exact H20.
------------------- destruct H21 as [H21 H22].
assert (* AndElim *) ((euclidean__axioms.Col Q B A) /\ ((euclidean__axioms.Col B Q A) /\ (euclidean__axioms.Col Q A B))) as H23.
-------------------- exact H22.
-------------------- destruct H23 as [H23 H24].
assert (* AndElim *) ((euclidean__axioms.Col B Q A) /\ (euclidean__axioms.Col Q A B)) as H25.
--------------------- exact H24.
...
------------------ apply (@lemma__betweennotequal.lemma__betweennotequal (A) (C) (B) H).
------------------ assert (* AndElim *) ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B))) as H20.
------------------- exact H19.
------------------- destruct H20 as [H20 H21].
assert (* AndElim *) ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B)) as H22.
-------------------- exact H21.
-------------------- destruct H22 as [H22 H23].
exact H23.
...
------------------------- assert (* AndElim *) ((euclidean__defs.OS M P A B) /\ ((euclidean__defs.OS P M B A) /\ (euclidean__defs.OS M P B A))) as H27.
-------------------------- exact H26.
-------------------------- destruct H27 as [H27 H28].
assert (* AndElim *) ((euclidean__defs.OS P M B A) /\ (euclidean__defs.OS M P B A)) as H29.
--------------------------- exact H28.
--------------------------- destruct H29 as [H29 H30].
exact H27.
...
----------------------------- assert (* AndElim *) ((euclidean__axioms.Col M P Q) /\ ((euclidean__axioms.Col M Q P) /\ ((euclidean__axioms.Col Q P M) /\ ((euclidean__axioms.Col P Q M) /\ (euclidean__axioms.Col Q M P))))) as H31.
------------------------------ exact H30.
------------------------------ destruct H31 as [H31 H32].
assert (* AndElim *) ((euclidean__axioms.Col M Q P) /\ ((euclidean__axioms.Col Q P M) /\ ((euclidean__axioms.Col P Q M) /\ (euclidean__axioms.Col Q M P)))) as H33.
------------------------------- exact H32.
------------------------------- destruct H33 as [H33 H34].
assert (* AndElim *) ((euclidean__axioms.Col Q P M) /\ ((euclidean__axioms.Col P Q M) /\ (euclidean__axioms.Col Q M P))) as H35.
-------------------------------- exact H34.
-------------------------------- destruct H35 as [H35 H36].
assert (* AndElim *) ((euclidean__axioms.Col P Q M) /\ (euclidean__axioms.Col Q M P)) as H37.
--------------------------------- exact H36.
...
------------------------------ assert (* AndElim *) ((euclidean__axioms.Col M B Q) /\ ((euclidean__axioms.Col M Q B) /\ ((euclidean__axioms.Col Q B M) /\ ((euclidean__axioms.Col B Q M) /\ (euclidean__axioms.Col Q M B))))) as H32.
------------------------------- exact H31.
------------------------------- destruct H32 as [H32 H33].
assert (* AndElim *) ((euclidean__axioms.Col M Q B) /\ ((euclidean__axioms.Col Q B M) /\ ((euclidean__axioms.Col B Q M) /\ (euclidean__axioms.Col Q M B)))) as H34.
-------------------------------- exact H33.
-------------------------------- destruct H34 as [H34 H35].
assert (* AndElim *) ((euclidean__axioms.Col Q B M) /\ ((euclidean__axioms.Col B Q M) /\ (euclidean__axioms.Col Q M B))) as H36.
--------------------------------- exact H35.
--------------------------------- destruct H36 as [H36 H37].
assert (* AndElim *) ((euclidean__axioms.Col B Q M) /\ (euclidean__axioms.Col Q M B)) as H38.
---------------------------------- exact H37.
...
------------------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (P) (M) (Q) H11).
------------------------------- assert (* AndElim *) ((euclidean__axioms.neq M Q) /\ ((euclidean__axioms.neq P M) /\ (euclidean__axioms.neq P Q))) as H33.
-------------------------------- exact H32.
-------------------------------- destruct H33 as [H33 H34].
assert (* AndElim *) ((euclidean__axioms.neq P M) /\ (euclidean__axioms.neq P Q)) as H35.
--------------------------------- exact H34.
--------------------------------- destruct H35 as [H35 H36].
exact H33.
...
--------------------------------- assert (* AndElim *) ((euclidean__axioms.Col P Q B) /\ ((euclidean__axioms.Col P B Q) /\ ((euclidean__axioms.Col B Q P) /\ ((euclidean__axioms.Col Q B P) /\ (euclidean__axioms.Col B P Q))))) as H35.
---------------------------------- exact H34.
---------------------------------- destruct H35 as [H35 H36].
assert (* AndElim *) ((euclidean__axioms.Col P B Q) /\ ((euclidean__axioms.Col B Q P) /\ ((euclidean__axioms.Col Q B P) /\ (euclidean__axioms.Col B P Q)))) as H37.
----------------------------------- exact H36.
----------------------------------- destruct H37 as [H37 H38].
assert (* AndElim *) ((euclidean__axioms.Col B Q P) /\ ((euclidean__axioms.Col Q B P) /\ (euclidean__axioms.Col B P Q))) as H39.
------------------------------------ exact H38.
------------------------------------ destruct H39 as [H39 H40].
assert (* AndElim *) ((euclidean__axioms.Col Q B P) /\ (euclidean__axioms.Col B P Q)) as H41.
------------------------------------- exact H40.
...
---------------------------------- assert (* AndElim *) ((euclidean__axioms.Col Q A B) /\ ((euclidean__axioms.Col Q B A) /\ ((euclidean__axioms.Col B A Q) /\ ((euclidean__axioms.Col A B Q) /\ (euclidean__axioms.Col B Q A))))) as H36.
----------------------------------- exact H35.
----------------------------------- destruct H36 as [H36 H37].
assert (* AndElim *) ((euclidean__axioms.Col Q B A) /\ ((euclidean__axioms.Col B A Q) /\ ((euclidean__axioms.Col A B Q) /\ (euclidean__axioms.Col B Q A)))) as H38.
------------------------------------ exact H37.
------------------------------------ destruct H38 as [H38 H39].
assert (* AndElim *) ((euclidean__axioms.Col B A Q) /\ ((euclidean__axioms.Col A B Q) /\ (euclidean__axioms.Col B Q A))) as H40.
------------------------------------- exact H39.
------------------------------------- destruct H40 as [H40 H41].
assert (* AndElim *) ((euclidean__axioms.Col A B Q) /\ (euclidean__axioms.Col B Q A)) as H42.
-------------------------------------- exact H41.
...
----------------------------------- assert (* AndElim *) ((euclidean__axioms.neq C Q) /\ ((euclidean__axioms.neq B C) /\ (euclidean__axioms.neq B Q))) as H37.
------------------------------------ exact H36.
------------------------------------ destruct H37 as [H37 H38].
assert (* AndElim *) ((euclidean__axioms.neq B C) /\ (euclidean__axioms.neq B Q)) as H39.
------------------------------------- exact H38.
------------------------------------- destruct H39 as [H39 H40].
exact H40.
...
------------------------- assert (* Cut *) (exists (R: euclidean__axioms.Point), euclidean__defs.Perp__at M R A B R) as H28.
-------------------------- apply (@proposition__12.proposition__12 (A) (B) (M)).
---------------------------apply (@euclidean__tactics.nCol__notCol (A) (B) (M) H27).

-------------------------- assert (exists R: euclidean__axioms.Point, (euclidean__defs.Perp__at M R A B R)) as H29.
--------------------------- exact H28.
--------------------------- destruct H29 as [R H29].
assert (* Cut *) (exists (E: euclidean__axioms.Point), (euclidean__axioms.Col M R R) /\ ((euclidean__axioms.Col A B R) /\ ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E R M)))) as H30.
---------------------------- exact H29.
---------------------------- assert (exists E: euclidean__axioms.Point, ((euclidean__axioms.Col M R R) /\ ((euclidean__axioms.Col A B R) /\ ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E R M))))) as H31.
----------------------------- exact H30.
----------------------------- destruct H31 as [E H31].
assert (* AndElim *) ((euclidean__axioms.Col M R R) /\ ((euclidean__axioms.Col A B R) /\ ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E R M)))) as H32.
------------------------------ exact H31.
------------------------------ destruct H32 as [H32 H33].
assert (* AndElim *) ((euclidean__axioms.Col A B R) /\ ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E R M))) as H34.
------------------------------- exact H33.
------------------------------- destruct H34 as [H34 H35].
assert (* AndElim *) ((euclidean__axioms.Col A B E) /\ (euclidean__defs.Per E R M)) as H36.
-------------------------------- exact H35.
-------------------------------- destruct H36 as [H36 H37].
...
----------------------------------- apply (@eq__ind__r euclidean__axioms.Point R (fun M0: euclidean__axioms.Point => (euclidean__axioms.BetS P M0 Q) -> ((euclidean__axioms.Cong M0 P M0 Q) -> ((euclidean__axioms.BetS Q M0 P) -> ((euclidean__defs.Out Q P M0) -> ((euclidean__defs.OS P M0 A B) -> ((euclidean__defs.OS M0 P A B) -> ((~(euclidean__axioms.Col A B M0)) -> ((euclidean__defs.Perp__at M0 R A B R) -> ((euclidean__axioms.Col M0 R R) -> ((euclidean__defs.Per E R M0) -> ((euclidean__defs.Per M0 R E) -> (euclidean__axioms.Col A B M0))))))))))))) with (x := M).
------------------------------------intro H40.
intro H41.
intro H42.
intro H43.
...
------------------------------------ apply (@lemma__betweennotequal.lemma__betweennotequal (A) (C) (B) H).
------------------------------------ assert (* AndElim *) ((euclidean__axioms.neq C B) /\ ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B))) as H41.
------------------------------------- exact H40.
------------------------------------- destruct H41 as [H41 H42].
assert (* AndElim *) ((euclidean__axioms.neq A C) /\ (euclidean__axioms.neq A B)) as H43.
-------------------------------------- exact H42.
...
------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col B C A) /\ ((euclidean__axioms.Col B A C) /\ ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C A B) /\ (euclidean__axioms.Col A B C))))) as H42.
-------------------------------------- exact H41.
-------------------------------------- destruct H42 as [H42 H43].
assert (* AndElim *) ((euclidean__axioms.Col B A C) /\ ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C A B) /\ (euclidean__axioms.Col A B C)))) as H44.
--------------------------------------- exact H43.
--------------------------------------- destruct H44 as [H44 H45].
assert (* AndElim *) ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C A B) /\ (euclidean__axioms.Col A B C))) as H46.
---------------------------------------- exact H45.
---------------------------------------- destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Col C A B) /\ (euclidean__axioms.Col A B C)) as H48.
----------------------------------------- exact H47.
...
---------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col B A C) /\ ((euclidean__axioms.Col B C A) /\ ((euclidean__axioms.Col C A B) /\ ((euclidean__axioms.Col A C B) /\ (euclidean__axioms.Col C B A))))) as H45.
----------------------------------------- exact H44.
----------------------------------------- destruct H45 as [H45 H46].
assert (* AndElim *) ((euclidean__axioms.Col B C A) /\ ((euclidean__axioms.Col C A B) /\ ((euclidean__axioms.Col A C B) /\ (euclidean__axioms.Col C B A)))) as H47.
------------------------------------------ exact H46.
------------------------------------------ destruct H47 as [H47 H48].
assert (* AndElim *) ((euclidean__axioms.Col C A B) /\ ((euclidean__axioms.Col A C B) /\ (euclidean__axioms.Col C B A))) as H49.
------------------------------------------- exact H48.
------------------------------------------- destruct H49 as [H49 H50].
assert (* AndElim *) ((euclidean__axioms.Col A C B) /\ (euclidean__axioms.Col C B A)) as H51.
-------------------------------------------- exact H50.
...
----------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col B A R) /\ ((euclidean__axioms.Col B R A) /\ ((euclidean__axioms.Col R A B) /\ ((euclidean__axioms.Col A R B) /\ (euclidean__axioms.Col R B A))))) as H46.
------------------------------------------ exact H45.
------------------------------------------ destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Col B R A) /\ ((euclidean__axioms.Col R A B) /\ ((euclidean__axioms.Col A R B) /\ (euclidean__axioms.Col R B A)))) as H48.
------------------------------------------- exact H47.
------------------------------------------- destruct H48 as [H48 H49].
assert (* AndElim *) ((euclidean__axioms.Col R A B) /\ ((euclidean__axioms.Col A R B) /\ (euclidean__axioms.Col R B A))) as H50.
-------------------------------------------- exact H49.
-------------------------------------------- destruct H50 as [H50 H51].
assert (* AndElim *) ((euclidean__axioms.Col A R B) /\ (euclidean__axioms.Col R B A)) as H52.
--------------------------------------------- exact H51.
...
-------------------------------------------- assert (* Cut *) (euclidean__defs.Per E R M) as H50.
--------------------------------------------- exact H37.
...
------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq M P) /\ ((euclidean__axioms.neq Q M) /\ (euclidean__axioms.neq Q P))) as H54.
-------------------------------------------------- exact H53.
-------------------------------------------------- destruct H54 as [H54 H55].
assert (* AndElim *) ((euclidean__axioms.neq Q M) /\ (euclidean__axioms.neq Q P)) as H56.
--------------------------------------------------- exact H55.
...
---------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col R C E) /\ ((euclidean__axioms.Col R E C) /\ ((euclidean__axioms.Col E C R) /\ ((euclidean__axioms.Col C E R) /\ (euclidean__axioms.Col E R C))))) as H57.
----------------------------------------------------- exact H56.
----------------------------------------------------- destruct H57 as [H57 H58].
assert (* AndElim *) ((euclidean__axioms.Col R E C) /\ ((euclidean__axioms.Col E C R) /\ ((euclidean__axioms.Col C E R) /\ (euclidean__axioms.Col E R C)))) as H59.
------------------------------------------------------ exact H58.
------------------------------------------------------ destruct H59 as [H59 H60].
assert (* AndElim *) ((euclidean__axioms.Col E C R) /\ ((euclidean__axioms.Col C E R) /\ (euclidean__axioms.Col E R C))) as H61.
------------------------------------------------------- exact H60.
------------------------------------------------------- destruct H61 as [H61 H62].
assert (* AndElim *) ((euclidean__axioms.Col C E R) /\ (euclidean__axioms.Col E R C)) as H63.
-------------------------------------------------------- exact H62.
...
---------------------------------------- apply (@eq__ind__r euclidean__axioms.Point C (fun M0: euclidean__axioms.Point => (euclidean__axioms.BetS P M0 Q) -> ((euclidean__axioms.Cong M0 P M0 Q) -> ((euclidean__axioms.BetS Q M0 P) -> ((euclidean__defs.Out Q P M0) -> ((euclidean__defs.OS P M0 A B) -> ((euclidean__defs.OS M0 P A B) -> ((~(euclidean__axioms.Col A B M0)) -> ((euclidean__defs.Perp__at M0 R A B R) -> ((euclidean__axioms.Col M0 R R) -> ((euclidean__defs.Per E R M0) -> ((euclidean__defs.Per M0 R E) -> ((~(M0 = R)) -> ((euclidean__defs.Per A C M0) -> (euclidean__axioms.Col A B M0))))))))))))))) with (x := M).
-----------------------------------------intro H45.
intro H46.
intro H47.
intro H48.
...
----------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong Q C P C) /\ ((euclidean__axioms.Cong Q C C P) /\ (euclidean__axioms.Cong C Q P C))) as H46.
------------------------------------------ exact H45.
------------------------------------------ destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Cong Q C C P) /\ (euclidean__axioms.Cong C Q P C)) as H48.
------------------------------------------- exact H47.
------------------------------------------- destruct H48 as [H48 H49].
exact H46.
---------------------------------------- assert (* Cut *) (euclidean__axioms.BetS Q M P) as H46.
----------------------------------------- exact H22.
...
------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong Q M P M) /\ (euclidean__axioms.Cong P M Q M)) as H48.
-------------------------------------------- exact H47.
-------------------------------------------- destruct H48 as [H48 H49].
exact H48.
...
--------------------------------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (B) (C) (Q) H6).
--------------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq C Q) /\ ((euclidean__axioms.neq B C) /\ (euclidean__axioms.neq B Q))) as H50.
---------------------------------------------- exact H49.
---------------------------------------------- destruct H50 as [H50 H51].
assert (* AndElim *) ((euclidean__axioms.neq B C) /\ (euclidean__axioms.neq B Q)) as H52.
----------------------------------------------- exact H51.
----------------------------------------------- destruct H52 as [H52 H53].
exact H50.
-------------------------------------------- assert (* Cut *) (euclidean__axioms.neq Q C) as H50.
--------------------------------------------- apply (@lemma__inequalitysymmetric.lemma__inequalitysymmetric (C) (Q) H49).
--------------------------------------------- assert (* Cut *) (euclidean__defs.Per E R M) as H51.
---------------------------------------------- exact H37.
...
-------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col C B Q) /\ ((euclidean__axioms.Col C Q B) /\ ((euclidean__axioms.Col Q B C) /\ ((euclidean__axioms.Col B Q C) /\ (euclidean__axioms.Col Q C B))))) as H55.
--------------------------------------------------- exact H54.
--------------------------------------------------- destruct H55 as [H55 H56].
assert (* AndElim *) ((euclidean__axioms.Col C Q B) /\ ((euclidean__axioms.Col Q B C) /\ ((euclidean__axioms.Col B Q C) /\ (euclidean__axioms.Col Q C B)))) as H57.
---------------------------------------------------- exact H56.
---------------------------------------------------- destruct H57 as [H57 H58].
assert (* AndElim *) ((euclidean__axioms.Col Q B C) /\ ((euclidean__axioms.Col B Q C) /\ (euclidean__axioms.Col Q C B))) as H59.
----------------------------------------------------- exact H58.
----------------------------------------------------- destruct H59 as [H59 H60].
assert (* AndElim *) ((euclidean__axioms.Col B Q C) /\ (euclidean__axioms.Col Q C B)) as H61.
------------------------------------------------------ exact H60.
------------------------------------------------------ destruct H61 as [H61 H62].
exact H55.
...
--------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col B C Q) /\ ((euclidean__axioms.Col B Q C) /\ ((euclidean__axioms.Col Q C B) /\ ((euclidean__axioms.Col C Q B) /\ (euclidean__axioms.Col Q B C))))) as H56.
---------------------------------------------------- exact H55.
---------------------------------------------------- destruct H56 as [H56 H57].
assert (* AndElim *) ((euclidean__axioms.Col B Q C) /\ ((euclidean__axioms.Col Q C B) /\ ((euclidean__axioms.Col C Q B) /\ (euclidean__axioms.Col Q B C)))) as H58.
----------------------------------------------------- exact H57.
----------------------------------------------------- destruct H58 as [H58 H59].
assert (* AndElim *) ((euclidean__axioms.Col Q C B) /\ ((euclidean__axioms.Col C Q B) /\ (euclidean__axioms.Col Q B C))) as H60.
------------------------------------------------------ exact H59.
------------------------------------------------------ destruct H60 as [H60 H61].
assert (* AndElim *) ((euclidean__axioms.Col C Q B) /\ (euclidean__axioms.Col Q B C)) as H62.
------------------------------------------------------- exact H61.
...
-------------------------------------------------------- apply (@eq__ind euclidean__axioms.Point R (fun X: euclidean__axioms.Point => euclidean__defs.Per Q X M)) with (y := C).
--------------------------------------------------------- exact H60.
---------------------------------------------------------apply (@euclidean__tactics.NNPP (R = C) H43).
...
------------------------------------------------------ apply (@eq__ind__r euclidean__axioms.Point C (fun X: euclidean__axioms.Point => euclidean__axioms.Col A E X)) with (x := R).
-------------------------------------------------------apply (@eq__ind euclidean__axioms.Point B (fun X: euclidean__axioms.Point => euclidean__axioms.Col A X C)) with (y := E).
-------------------------------------------------------- exact H41.
...
-------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col E A R) /\ ((euclidean__axioms.Col E R A) /\ ((euclidean__axioms.Col R A E) /\ ((euclidean__axioms.Col A R E) /\ (euclidean__axioms.Col R E A))))) as H61.
--------------------------------------------------------- exact H60.
--------------------------------------------------------- destruct H61 as [H61 H62].
assert (* AndElim *) ((euclidean__axioms.Col E R A) /\ ((euclidean__axioms.Col R A E) /\ ((euclidean__axioms.Col A R E) /\ (euclidean__axioms.Col R E A)))) as H63.
---------------------------------------------------------- exact H62.
---------------------------------------------------------- destruct H63 as [H63 H64].
assert (* AndElim *) ((euclidean__axioms.Col R A E) /\ ((euclidean__axioms.Col A R E) /\ (euclidean__axioms.Col R E A))) as H65.
----------------------------------------------------------- exact H64.
----------------------------------------------------------- destruct H65 as [H65 H66].
assert (* AndElim *) ((euclidean__axioms.Col A R E) /\ (euclidean__axioms.Col R E A)) as H67.
------------------------------------------------------------ exact H66.
------------------------------------------------------------ destruct H67 as [H67 H68].
exact H18.
------------------------------------------------------- assert (* Cut *) (euclidean__axioms.Col A E Q) as H61.
-------------------------------------------------------- apply (@eq__ind euclidean__axioms.Point B (fun X: euclidean__axioms.Point => euclidean__axioms.Col A X Q)) with (y := E).
--------------------------------------------------------- exact H60.
---------------------------------------------------------apply (@euclidean__tactics.NNPP (B = E) H58).
