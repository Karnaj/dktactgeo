...
Definition proposition__20 : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point), (euclidean__axioms.Triangle A B C) -> (euclidean__defs.TG B A A C B C).
Proof.
intro A.
intro B.
intro C.
...
----- assert (* AndElim *) ((euclidean__axioms.Col A B C) /\ ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B))))) as H4.
------ exact H3.
------ destruct H4 as [H4 H5].
assert (* AndElim *) ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B)))) as H6.
------- exact H5.
------- destruct H6 as [H6 H7].
assert (* AndElim *) ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B))) as H8.
-------- exact H7.
-------- destruct H8 as [H8 H9].
assert (* AndElim *) ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B)) as H10.
--------- exact H9.
...
-------- assert (* AndElim *) ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col C A B) /\ ((euclidean__axioms.Col A B C) /\ ((euclidean__axioms.Col B A C) /\ (euclidean__axioms.Col A C B))))) as H7.
--------- exact H6.
--------- destruct H7 as [H7 H8].
assert (* AndElim *) ((euclidean__axioms.Col C A B) /\ ((euclidean__axioms.Col A B C) /\ ((euclidean__axioms.Col B A C) /\ (euclidean__axioms.Col A C B)))) as H9.
---------- exact H8.
---------- destruct H9 as [H9 H10].
assert (* AndElim *) ((euclidean__axioms.Col A B C) /\ ((euclidean__axioms.Col B A C) /\ (euclidean__axioms.Col A C B))) as H11.
----------- exact H10.
----------- destruct H11 as [H11 H12].
assert (* AndElim *) ((euclidean__axioms.Col B A C) /\ (euclidean__axioms.Col A C B)) as H13.
------------ exact H12.
------------ destruct H13 as [H13 H14].
exact H11.
------- apply (@euclidean__tactics.Col__nCol__False (A) (B) (C) (H0) H6).
----- assert (* Cut *) (exists (D: euclidean__axioms.Point), (euclidean__axioms.BetS B A D) /\ (euclidean__axioms.Cong A D C A)) as H5.
------ apply (@lemma__extension.lemma__extension (B) (A) (C) (A) (H1) H4).
------ assert (exists D: euclidean__axioms.Point, ((euclidean__axioms.BetS B A D) /\ (euclidean__axioms.Cong A D C A))) as H6.
------- exact H5.
------- destruct H6 as [D H6].
assert (* AndElim *) ((euclidean__axioms.BetS B A D) /\ (euclidean__axioms.Cong A D C A)) as H7.
-------- exact H6.
-------- destruct H7 as [H7 H8].
...
---------- assert (* AndElim *) ((euclidean__axioms.neq A D) /\ ((euclidean__axioms.neq B A) /\ (euclidean__axioms.neq B D))) as H10.
----------- exact H9.
----------- destruct H10 as [H10 H11].
assert (* AndElim *) ((euclidean__axioms.neq B A) /\ (euclidean__axioms.neq B D)) as H12.
------------ exact H11.
...
------------ apply (@lemma__betweennotequal.lemma__betweennotequal (B) (A) (D) H7).
------------ assert (* AndElim *) ((euclidean__axioms.neq A D) /\ ((euclidean__axioms.neq B A) /\ (euclidean__axioms.neq B D))) as H12.
------------- exact H11.
------------- destruct H12 as [H12 H13].
assert (* AndElim *) ((euclidean__axioms.neq B A) /\ (euclidean__axioms.neq B D)) as H14.
-------------- exact H13.
...
-------------- assert (* AndElim *) ((euclidean__axioms.Cong D A A C) /\ ((euclidean__axioms.Cong D A C A) /\ (euclidean__axioms.Cong A D A C))) as H14.
--------------- exact H13.
--------------- destruct H14 as [H14 H15].
assert (* AndElim *) ((euclidean__axioms.Cong D A C A) /\ (euclidean__axioms.Cong A D A C)) as H16.
---------------- exact H15.
...
----------------- assert (* AndElim *) ((euclidean__axioms.Col A B D) /\ ((euclidean__axioms.Col A D B) /\ ((euclidean__axioms.Col D B A) /\ ((euclidean__axioms.Col B D A) /\ (euclidean__axioms.Col D A B))))) as H17.
------------------ exact H16.
------------------ destruct H17 as [H17 H18].
assert (* AndElim *) ((euclidean__axioms.Col A D B) /\ ((euclidean__axioms.Col D B A) /\ ((euclidean__axioms.Col B D A) /\ (euclidean__axioms.Col D A B)))) as H19.
------------------- exact H18.
------------------- destruct H19 as [H19 H20].
assert (* AndElim *) ((euclidean__axioms.Col D B A) /\ ((euclidean__axioms.Col B D A) /\ (euclidean__axioms.Col D A B))) as H21.
-------------------- exact H20.
-------------------- destruct H21 as [H21 H22].
assert (* AndElim *) ((euclidean__axioms.Col B D A) /\ (euclidean__axioms.Col D A B)) as H23.
--------------------- exact H22.
...
------------------ assert (* AndElim *) ((euclidean__axioms.Col D A C) /\ ((euclidean__axioms.Col D C A) /\ ((euclidean__axioms.Col C A D) /\ ((euclidean__axioms.Col A C D) /\ (euclidean__axioms.Col C D A))))) as H18.
------------------- exact H17.
------------------- destruct H18 as [H18 H19].
assert (* AndElim *) ((euclidean__axioms.Col D C A) /\ ((euclidean__axioms.Col C A D) /\ ((euclidean__axioms.Col A C D) /\ (euclidean__axioms.Col C D A)))) as H20.
-------------------- exact H19.
-------------------- destruct H20 as [H20 H21].
assert (* AndElim *) ((euclidean__axioms.Col C A D) /\ ((euclidean__axioms.Col A C D) /\ (euclidean__axioms.Col C D A))) as H22.
--------------------- exact H21.
--------------------- destruct H22 as [H22 H23].
assert (* AndElim *) ((euclidean__axioms.Col A C D) /\ (euclidean__axioms.Col C D A)) as H24.
---------------------- exact H23.
...
------------------- apply (@lemma__betweennotequal.lemma__betweennotequal (B) (A) (D) H7).
------------------- assert (* AndElim *) ((euclidean__axioms.neq A D) /\ ((euclidean__axioms.neq B A) /\ (euclidean__axioms.neq B D))) as H19.
-------------------- exact H18.
-------------------- destruct H19 as [H19 H20].
assert (* AndElim *) ((euclidean__axioms.neq B A) /\ (euclidean__axioms.neq B D)) as H21.
--------------------- exact H20.
--------------------- destruct H21 as [H21 H22].
exact H9.
------------------ assert (* Cut *) (euclidean__axioms.neq D A) as H19.
------------------- exact H10.
...
--------------------- assert (* AndElim *) ((euclidean__axioms.Col C A D) /\ ((euclidean__axioms.Col C D A) /\ ((euclidean__axioms.Col D A C) /\ ((euclidean__axioms.Col A D C) /\ (euclidean__axioms.Col D C A))))) as H21.
---------------------- exact H20.
---------------------- destruct H21 as [H21 H22].
assert (* AndElim *) ((euclidean__axioms.Col C D A) /\ ((euclidean__axioms.Col D A C) /\ ((euclidean__axioms.Col A D C) /\ (euclidean__axioms.Col D C A)))) as H23.
----------------------- exact H22.
----------------------- destruct H23 as [H23 H24].
assert (* AndElim *) ((euclidean__axioms.Col D A C) /\ ((euclidean__axioms.Col A D C) /\ (euclidean__axioms.Col D C A))) as H25.
------------------------ exact H24.
------------------------ destruct H25 as [H25 H26].
assert (* AndElim *) ((euclidean__axioms.Col A D C) /\ (euclidean__axioms.Col D C A)) as H27.
------------------------- exact H26.
...
------------------------------------------ assert (* AndElim *) ((euclidean__axioms.Col A B D) /\ ((euclidean__axioms.Col A D B) /\ ((euclidean__axioms.Col D B A) /\ ((euclidean__axioms.Col B D A) /\ (euclidean__axioms.Col D A B))))) as H42.
------------------------------------------- exact H41.
------------------------------------------- destruct H42 as [H42 H43].
assert (* AndElim *) ((euclidean__axioms.Col A D B) /\ ((euclidean__axioms.Col D B A) /\ ((euclidean__axioms.Col B D A) /\ (euclidean__axioms.Col D A B)))) as H44.
-------------------------------------------- exact H43.
-------------------------------------------- destruct H44 as [H44 H45].
assert (* AndElim *) ((euclidean__axioms.Col D B A) /\ ((euclidean__axioms.Col B D A) /\ (euclidean__axioms.Col D A B))) as H46.
--------------------------------------------- exact H45.
--------------------------------------------- destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Col B D A) /\ (euclidean__axioms.Col D A B)) as H48.
---------------------------------------------- exact H47.
...
------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col C B D) /\ ((euclidean__axioms.Col C D B) /\ ((euclidean__axioms.Col D B C) /\ ((euclidean__axioms.Col B D C) /\ (euclidean__axioms.Col D C B))))) as H43.
-------------------------------------------- exact H42.
-------------------------------------------- destruct H43 as [H43 H44].
assert (* AndElim *) ((euclidean__axioms.Col C D B) /\ ((euclidean__axioms.Col D B C) /\ ((euclidean__axioms.Col B D C) /\ (euclidean__axioms.Col D C B)))) as H45.
--------------------------------------------- exact H44.
--------------------------------------------- destruct H45 as [H45 H46].
assert (* AndElim *) ((euclidean__axioms.Col D B C) /\ ((euclidean__axioms.Col B D C) /\ (euclidean__axioms.Col D C B))) as H47.
---------------------------------------------- exact H46.
---------------------------------------------- destruct H47 as [H47 H48].
assert (* AndElim *) ((euclidean__axioms.Col B D C) /\ (euclidean__axioms.Col D C B)) as H49.
----------------------------------------------- exact H48.
...
-------------------------------------------- assert (* AndElim *) ((euclidean__axioms.neq A B) /\ ((euclidean__axioms.neq D A) /\ (euclidean__axioms.neq D B))) as H44.
--------------------------------------------- exact H43.
--------------------------------------------- destruct H44 as [H44 H45].
assert (* AndElim *) ((euclidean__axioms.neq D A) /\ (euclidean__axioms.neq D B)) as H46.
---------------------------------------------- exact H45.
---------------------------------------------- destruct H46 as [H46 H47].
exact H11.
------------------------------------------- assert (* Cut *) (euclidean__axioms.neq D B) as H44.
-------------------------------------------- exact H12.
...
----------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col A B C) /\ ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B))))) as H47.
------------------------------------------------ exact H46.
------------------------------------------------ destruct H47 as [H47 H48].
assert (* AndElim *) ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B)))) as H49.
------------------------------------------------- exact H48.
------------------------------------------------- destruct H49 as [H49 H50].
assert (* AndElim *) ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B))) as H51.
-------------------------------------------------- exact H50.
-------------------------------------------------- destruct H51 as [H51 H52].
assert (* AndElim *) ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B)) as H53.
--------------------------------------------------- exact H52.
...
------------------------------------------ assert (* AndElim *) ((euclidean__axioms.Col D C B) /\ ((euclidean__axioms.Col D B C) /\ ((euclidean__axioms.Col B C D) /\ ((euclidean__axioms.Col C B D) /\ (euclidean__axioms.Col B D C))))) as H42.
------------------------------------------- exact H41.
------------------------------------------- destruct H42 as [H42 H43].
assert (* AndElim *) ((euclidean__axioms.Col D B C) /\ ((euclidean__axioms.Col B C D) /\ ((euclidean__axioms.Col C B D) /\ (euclidean__axioms.Col B D C)))) as H44.
-------------------------------------------- exact H43.
-------------------------------------------- destruct H44 as [H44 H45].
assert (* AndElim *) ((euclidean__axioms.Col B C D) /\ ((euclidean__axioms.Col C B D) /\ (euclidean__axioms.Col B D C))) as H46.
--------------------------------------------- exact H45.
--------------------------------------------- destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Col C B D) /\ (euclidean__axioms.Col B D C)) as H48.
---------------------------------------------- exact H47.
---------------------------------------------- destruct H48 as [H48 H49].
exact H46.
----------------------------------------- apply (@H14).
