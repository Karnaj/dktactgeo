...
Definition lemma__differenceofparts : forall A B C a b c, (euclidean__axioms.Cong A B a b) -> ((euclidean__axioms.Cong A C a c) -> ((euclidean__axioms.BetS A B C) -> ((euclidean__axioms.BetS a b c) -> (euclidean__axioms.Cong B C b c)))).
Proof.
intro A.
intro B.
intro C.
...
-- assert ((B = A) \/ (euclidean__axioms.neq B A)) as H4 by exact H3.
assert ((B = A) \/ (euclidean__axioms.neq B A)) as __TmpHyp by exact H4.
destruct __TmpHyp as [H5|H5].
--- assert (* Cut *) (euclidean__axioms.Cong A A a b) as H6.
---- apply (@eq__ind__r euclidean__axioms.Point A (fun B0 => (euclidean__axioms.Cong A B0 a b) -> ((euclidean__axioms.BetS A B0 C) -> (euclidean__axioms.Cong A A a b)))) with (x := B).
-----intro H6.
intro H7.
exact H6.
...
---------- apply (@H9 H10).
--------- assert (False) as H11 by exact H10.
apply (@logic.eq__refl Point A).
-------- apply (@H9 H10).
...
-------- apply (@eq__ind__r euclidean__axioms.Point A (fun B0 => (euclidean__axioms.Cong A B0 a b) -> ((euclidean__axioms.BetS A B0 C) -> (euclidean__axioms.Cong B0 C A C)))) with (x := B).
---------intro H10.
intro H11.
exact H9.
...
--------- apply (@eq__ind__r euclidean__axioms.Point A (fun B0 => (euclidean__axioms.Cong A B0 a b) -> ((euclidean__axioms.BetS A B0 C) -> ((euclidean__axioms.Cong B0 C A C) -> (euclidean__axioms.Cong B0 C a c))))) with (x := B).
----------intro H11.
intro H12.
intro H13.
exact H0.
...
----------- apply (@eq__ind__r euclidean__axioms.Point b (fun X => euclidean__axioms.Cong b c X c)) with (x := a).
------------ exact H12.
...
----- apply (@eq__ind__r euclidean__axioms.Point A (fun C0 => (euclidean__axioms.Cong A C0 a c) -> ((euclidean__axioms.BetS A B C0) -> (euclidean__axioms.BetS A B A)))) with (x := C).
------intro H7.
intro H8.
exact H8.
...
----- assert (* Cut *) (exists E, (euclidean__axioms.BetS C A E) /\ (euclidean__axioms.Cong A E A C)) as H8.
------ apply (@lemma__localextension.lemma__localextension C A C H6 H7).
------ destruct H8 as [E H9].
destruct H9 as [H10 H11].
assert (euclidean__axioms.neq A C) as H12 by exact H7.
...
-------- assert (* Cut *) (exists e, (euclidean__axioms.BetS c a e) /\ (euclidean__axioms.Cong a e a c)) as H15.
--------- apply (@lemma__localextension.lemma__localextension c a c H14 H13).
--------- destruct H15 as [e H16].
...
--------------- assert (euclidean__axioms.Cong E A a c) as H25 by exact H21.
