...
Definition lemma__collinearparallel2 : forall A B C D E F, (euclidean__defs.Par A B C D) -> ((euclidean__axioms.Col C D E) -> ((euclidean__axioms.Col C D F) -> ((euclidean__axioms.neq E F) -> (euclidean__defs.Par A B E F)))).
Proof.
intro A.
intro B.
intro C.
...
----------- assert ((E = D) \/ (euclidean__axioms.neq E D)) as H13 by exact H12.
assert ((E = D) \/ (euclidean__axioms.neq E D)) as __TmpHyp by exact H13.
destruct __TmpHyp as [H14|H14].
------------ assert (* Cut *) (euclidean__axioms.neq D F) as H15.
------------- apply (@eq__ind__r euclidean__axioms.Point D (fun E0 => (euclidean__axioms.Col C D E0) -> ((euclidean__axioms.neq E0 F) -> ((euclidean__axioms.neq F E0) -> ((euclidean__axioms.Col D C E0) -> ((euclidean__axioms.Col C E0 F) -> ((euclidean__axioms.Col C F E0) -> (euclidean__axioms.neq D F)))))))) with (x := E).
--------------intro H15.
intro H16.
intro H17.
intro H18.
...
-------------- apply (@eq__ind__r euclidean__axioms.Point D (fun E0 => (euclidean__axioms.Col C D E0) -> ((euclidean__axioms.neq E0 F) -> ((euclidean__axioms.neq F E0) -> ((euclidean__axioms.Col D C E0) -> ((euclidean__axioms.Col C E0 F) -> ((euclidean__axioms.Col C F E0) -> (euclidean__axioms.neq F D)))))))) with (x := E).
---------------intro H16.
intro H17.
intro H18.
intro H19.
...
-------------------- assert ((C = F) \/ (euclidean__axioms.neq C F)) as H22 by exact H21.
assert ((C = F) \/ (euclidean__axioms.neq C F)) as __TmpHyp0 by exact H22.
destruct __TmpHyp0 as [H23|H23].
...
intro H37.
intro H38.
apply (@eq__ind__r euclidean__axioms.Point D (fun E0 => (euclidean__axioms.Col F D E0) -> ((euclidean__axioms.neq E0 F) -> ((euclidean__axioms.neq F E0) -> ((euclidean__axioms.Col F F E0) -> ((euclidean__axioms.Col F E0 F) -> ((euclidean__axioms.Col D F E0) -> ((euclidean__axioms.Col F F E0) -> ((euclidean__axioms.Col F D E0) -> (euclidean__axioms.Col F D E0)))))))))) with (x := E).
-------------------------intro H39.
intro H40.
intro H41.
intro H42.
