...
Definition lemma__betweennesspreserved : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (a: euclidean__axioms.Point) (b: euclidean__axioms.Point) (c: euclidean__axioms.Point), (euclidean__axioms.Cong A B a b) -> ((euclidean__axioms.Cong A C a c) -> ((euclidean__axioms.Cong B C b c) -> ((euclidean__axioms.BetS A B C) -> (euclidean__axioms.BetS a b c)))).
Proof.
intro A.
intro B.
intro C.
...
-- assert (* AndElim *) ((euclidean__axioms.neq B C) /\ ((euclidean__axioms.neq A B) /\ (euclidean__axioms.neq A C))) as H4.
--- exact H3.
--- destruct H4 as [H4 H5].
assert (* AndElim *) ((euclidean__axioms.neq A B) /\ (euclidean__axioms.neq A C)) as H6.
---- exact H5.
...
---- assert (* Cut *) (exists (d: euclidean__axioms.Point), (euclidean__axioms.BetS a b d) /\ (euclidean__axioms.Cong b d b c)) as H7.
----- apply (@lemma__localextension.lemma__localextension (a) (b) (c) (H4) H6).
----- assert (exists d: euclidean__axioms.Point, ((euclidean__axioms.BetS a b d) /\ (euclidean__axioms.Cong b d b c))) as H8.
------ exact H7.
------ destruct H8 as [d H8].
assert (* AndElim *) ((euclidean__axioms.BetS a b d) /\ (euclidean__axioms.Cong b d b c)) as H9.
------- exact H8.
...
--------------- apply (@eq__ind__r euclidean__axioms.Point d (fun X: euclidean__axioms.Point => euclidean__axioms.BetS a b X)) with (x := c).
---------------- exact H9.
