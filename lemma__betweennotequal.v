...
Definition lemma__betweennotequal : forall A B C, (euclidean__axioms.BetS A B C) -> ((euclidean__axioms.neq B C) /\ ((euclidean__axioms.neq A B) /\ (euclidean__axioms.neq A C))).
Proof.
intro A.
intro B.
intro C.
...
-- apply (@eq__ind__r euclidean__axioms.Point C (fun B0 => (euclidean__axioms.BetS A B0 C) -> (euclidean__axioms.BetS A C B0))) with (x := B).
---intro H1.
exact H1.
...
--- apply (@eq__ind__r euclidean__axioms.Point B (fun A0 => (euclidean__axioms.BetS A0 B C) -> (euclidean__axioms.BetS B A0 C))) with (x := A).
----intro H2.
exact H2.
...
--- intro H2.
assert (* Cut *) (euclidean__axioms.BetS A B A) as H3.
---- apply (@eq__ind__r euclidean__axioms.Point C (fun A0 => (euclidean__axioms.BetS A0 B C) -> ((~(A0 = B)) -> (euclidean__axioms.BetS A0 B A0)))) with (x := A).
-----intro H3.
intro H4.
exact H3.
