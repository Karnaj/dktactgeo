...
Definition lemma__21helper : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (E: euclidean__axioms.Point), (euclidean__defs.TG B A A E B E) -> ((euclidean__axioms.BetS A E C) -> (euclidean__defs.TT B A A C B E E C)).
Proof.
intro A.
intro B.
intro C.
...
intro H.
intro H0.
assert (* Cut *) (exists (H1: euclidean__axioms.Point), (euclidean__axioms.BetS B A H1) /\ ((euclidean__axioms.Cong A H1 A E) /\ (euclidean__defs.Lt B E B H1))) as H1.
- exact H.
- assert (exists H2: euclidean__axioms.Point, ((euclidean__axioms.BetS B A H2) /\ ((euclidean__axioms.Cong A H2 A E) /\ (euclidean__defs.Lt B E B H2)))) as H3.
-- exact H1.
-- destruct H3 as [H2 H3].
assert (* AndElim *) ((euclidean__axioms.BetS B A H2) /\ ((euclidean__axioms.Cong A H2 A E) /\ (euclidean__defs.Lt B E B H2))) as H4.
--- exact H3.
--- destruct H4 as [H4 H5].
assert (* AndElim *) ((euclidean__axioms.Cong A H2 A E) /\ (euclidean__defs.Lt B E B H2)) as H6.
---- exact H5.
...
------ assert (* AndElim *) ((euclidean__axioms.neq A H2) /\ ((euclidean__axioms.neq B A) /\ (euclidean__axioms.neq B H2))) as H9.
------- exact H8.
------- destruct H9 as [H9 H10].
assert (* AndElim *) ((euclidean__axioms.neq B A) /\ (euclidean__axioms.neq B H2)) as H11.
-------- exact H10.
...
------- apply (@eq__ind__r euclidean__axioms.Point E (fun B0: euclidean__axioms.Point => (euclidean__defs.TG B0 A A E B0 E) -> ((euclidean__axioms.BetS B0 A H2) -> ((euclidean__defs.Lt B0 E B0 H2) -> ((euclidean__axioms.neq B0 A) -> (euclidean__defs.Lt B0 B0 B0 H2)))))) with (x := B).
--------intro H10.
intro H11.
intro H12.
intro H13.
...
-------- exact H7.
-------- exact H8.
------- assert (* Cut *) (exists (K: euclidean__axioms.Point), (euclidean__axioms.BetS B K H2) /\ (euclidean__axioms.Cong B K B B)) as H11.
-------- exact H10.
-------- assert (exists K: euclidean__axioms.Point, ((euclidean__axioms.BetS B K H2) /\ (euclidean__axioms.Cong B K B B))) as H12.
--------- exact H11.
--------- destruct H12 as [K H12].
assert (* AndElim *) ((euclidean__axioms.BetS B K H2) /\ (euclidean__axioms.Cong B K B B)) as H13.
---------- exact H12.
...
------------ apply (@eq__ind__r euclidean__axioms.Point K (fun X: euclidean__axioms.Point => euclidean__axioms.BetS B X H2)) with (x := B).
------------- exact H13.
...
-------------- assert (* AndElim *) ((euclidean__axioms.neq B H2) /\ ((euclidean__axioms.neq B B) /\ (euclidean__axioms.neq B H2))) as H18.
--------------- exact H17.
--------------- destruct H18 as [H18 H19].
assert (* AndElim *) ((euclidean__axioms.neq B B) /\ (euclidean__axioms.neq B H2)) as H20.
---------------- exact H19.
...
-------- assert (* AndElim *) ((euclidean__axioms.neq E C) /\ ((euclidean__axioms.neq A E) /\ (euclidean__axioms.neq A C))) as H11.
--------- exact H10.
--------- destruct H11 as [H11 H12].
assert (* AndElim *) ((euclidean__axioms.neq A E) /\ (euclidean__axioms.neq A C)) as H13.
---------- exact H12.
---------- destruct H13 as [H13 H14].
exact H14.
------- assert (* Cut *) (exists (F: euclidean__axioms.Point), (euclidean__axioms.BetS B A F) /\ (euclidean__axioms.Cong A F A C)) as H11.
-------- apply (@lemma__extension.lemma__extension (B) (A) (A) (C) (H8) H10).
-------- assert (exists F: euclidean__axioms.Point, ((euclidean__axioms.BetS B A F) /\ (euclidean__axioms.Cong A F A C))) as H12.
--------- exact H11.
--------- destruct H12 as [F H12].
assert (* AndElim *) ((euclidean__axioms.BetS B A F) /\ (euclidean__axioms.Cong A F A C)) as H13.
---------- exact H12.
---------- destruct H13 as [H13 H14].
...
------------ apply (@lemma__betweennotequal.lemma__betweennotequal (A) (E) (C) H0).
------------ assert (* AndElim *) ((euclidean__axioms.neq E C) /\ ((euclidean__axioms.neq A E) /\ (euclidean__axioms.neq A C))) as H16.
------------- exact H15.
------------- destruct H16 as [H16 H17].
assert (* AndElim *) ((euclidean__axioms.neq A E) /\ (euclidean__axioms.neq A C)) as H18.
-------------- exact H17.
-------------- destruct H18 as [H18 H19].
exact H16.
----------- assert (* Cut *) (exists (G: euclidean__axioms.Point), (euclidean__axioms.BetS B E G) /\ (euclidean__axioms.Cong E G E C)) as H16.
------------ apply (@lemma__extension.lemma__extension (B) (E) (E) (C) (H9) H15).
------------ assert (exists G: euclidean__axioms.Point, ((euclidean__axioms.BetS B E G) /\ (euclidean__axioms.Cong E G E C))) as H17.
------------- exact H16.
------------- destruct H17 as [G H17].
assert (* AndElim *) ((euclidean__axioms.BetS B E G) /\ (euclidean__axioms.Cong E G E C)) as H18.
-------------- exact H17.
-------------- destruct H18 as [H18 H19].
