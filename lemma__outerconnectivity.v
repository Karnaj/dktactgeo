...
Definition lemma__outerconnectivity : forall A B C D, (euclidean__axioms.BetS A B C) -> ((euclidean__axioms.BetS A B D) -> ((~(euclidean__axioms.BetS B C D)) -> ((~(euclidean__axioms.BetS B D C)) -> (C = D)))).
Proof.
intro A.
intro B.
intro C.
...
-- apply (@eq__ind__r euclidean__axioms.Point C (fun A0 => (euclidean__axioms.BetS A0 B C) -> ((euclidean__axioms.BetS A0 B D) -> (euclidean__axioms.BetS A0 B A0)))) with (x := A).
---intro H4.
intro H5.
exact H4.
...
exact H8.
-- assert (* Cut *) (exists E, (euclidean__axioms.BetS A C E) /\ (euclidean__axioms.Cong C E A D)) as H5.
...
------ apply (@eq__ind__r euclidean__axioms.Point D (fun A0 => (euclidean__axioms.BetS A0 B C) -> ((euclidean__axioms.BetS A0 B D) -> ((~(A0 = C)) -> ((euclidean__axioms.neq A0 D) -> ((euclidean__axioms.BetS A0 C E) -> ((euclidean__axioms.Cong C E A0 D) -> ((euclidean__axioms.BetS A0 B E) -> (euclidean__axioms.BetS A0 B A0))))))))) with (x := A).
-------intro H11.
intro H12.
intro H13.
intro H14.
...
exact H3.
------ assert (* Cut *) (exists F, (euclidean__axioms.BetS A D F) /\ (euclidean__axioms.Cong D F A C)) as H12.
...
------------------------ apply (@eq__ind__r euclidean__axioms.Point F (fun E0 => (euclidean__axioms.BetS A C E0) -> ((euclidean__axioms.Cong C E0 A D) -> ((euclidean__axioms.BetS A B E0) -> ((euclidean__axioms.Cong A D C E0) -> ((euclidean__axioms.Cong D A C E0) -> ((euclidean__axioms.Cong F A A E0) -> ((euclidean__axioms.Cong A E0 F A) -> ((euclidean__axioms.Cong A E0 A F) -> ((euclidean__axioms.Cong B E0 B F) -> (euclidean__axioms.BetS A D E0))))))))))) with (x := E).
-------------------------intro H32.
intro H33.
intro H34.
intro H35.
