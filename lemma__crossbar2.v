...
Definition lemma__crossbar2 : forall A G H P S T, (euclidean__defs.LtA H G A H G P) -> ((euclidean__defs.OS A P G H) -> ((euclidean__defs.Out G H S) -> ((euclidean__defs.Out G P T) -> (exists X, (euclidean__axioms.BetS T X S) /\ (euclidean__defs.Out G A X))))).
Proof.
intro A.
intro G.
intro H.
...
- assert (exists X U V, (euclidean__axioms.Col G H U) /\ ((euclidean__axioms.Col G H V) /\ ((euclidean__axioms.BetS A U X) /\ ((euclidean__axioms.BetS P V X) /\ ((euclidean__axioms.nCol G H A) /\ (euclidean__axioms.nCol G H P)))))) as H4 by exact H1.
assert (exists X U V, (euclidean__axioms.Col G H U) /\ ((euclidean__axioms.Col G H V) /\ ((euclidean__axioms.BetS A U X) /\ ((euclidean__axioms.BetS P V X) /\ ((euclidean__axioms.nCol G H A) /\ (euclidean__axioms.nCol G H P)))))) as __TmpHyp by exact H4.
...
exact H17.
- assert (* Cut *) (exists J K L, (euclidean__axioms.BetS L K J) /\ ((euclidean__defs.Out G H L) /\ ((euclidean__defs.Out G P J) /\ (euclidean__defs.CongA H G A H G K)))) as H5.
-- assert (exists U X V, (euclidean__axioms.BetS U X V) /\ ((euclidean__defs.Out G H U) /\ ((euclidean__defs.Out G P V) /\ (euclidean__defs.CongA H G A H G X)))) as H5 by exact H0.
assert (exists U X V, (euclidean__axioms.BetS U X V) /\ ((euclidean__defs.Out G H U) /\ ((euclidean__defs.Out G P V) /\ (euclidean__defs.CongA H G A H G X)))) as __TmpHyp by exact H5.
...
------- assert (* Cut *) (exists M, (euclidean__defs.Out G K M) /\ (euclidean__axioms.BetS S M T)) as H20.
...
------------ assert (* Cut *) (exists N, (euclidean__defs.Out G A N) /\ (euclidean__axioms.Cong G N G M)) as H28.
------------- apply (@lemma__layoff.lemma__layoff G A G M H26 H27).
------------- destruct H28 as [N H29].
destruct H29 as [H30 H31].
...
exact H46.
-------------------- assert (euclidean__axioms.neq G M) as H39 by exact H27.
...
---------------------------- assert (* Cut *) (forall A0 B C a b c, (euclidean__axioms.Cong A0 B a b) -> ((euclidean__axioms.Cong A0 C a c) -> ((euclidean__defs.CongA B A0 C b a c) -> (euclidean__axioms.Cong B C b c)))) as H46.
----------------------------- intro A0.
intro B.
intro C.
intro a.
...
intro H74.
intro H75.
assert (M = M) as H76 by exact H75.
exact H64.
