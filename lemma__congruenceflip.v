...
Definition lemma__congruenceflip : forall A B C D, (euclidean__axioms.Cong A B C D) -> ((euclidean__axioms.Cong B A D C) /\ ((euclidean__axioms.Cong B A C D) /\ (euclidean__axioms.Cong A B D C))).
Proof.
intro A.
intro B.
intro C.
