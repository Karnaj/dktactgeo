...
Definition proposition__25 : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (D: euclidean__axioms.Point) (E: euclidean__axioms.Point) (F: euclidean__axioms.Point), (euclidean__axioms.Triangle A B C) -> ((euclidean__axioms.Triangle D E F) -> ((euclidean__axioms.Cong A B D E) -> ((euclidean__axioms.Cong A C D F) -> ((euclidean__defs.Lt E F B C) -> (euclidean__defs.LtA E D F B A C))))).
Proof.
intro A.
intro B.
intro C.
...
------- assert (* AndElim *) ((euclidean__axioms.Col A B C) /\ ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B))))) as H10.
-------- exact H9.
-------- destruct H10 as [H10 H11].
assert (* AndElim *) ((euclidean__axioms.Col A C B) /\ ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B)))) as H12.
--------- exact H11.
--------- destruct H12 as [H12 H13].
assert (* AndElim *) ((euclidean__axioms.Col C B A) /\ ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B))) as H14.
---------- exact H13.
---------- destruct H14 as [H14 H15].
assert (* AndElim *) ((euclidean__axioms.Col B C A) /\ (euclidean__axioms.Col C A B)) as H16.
----------- exact H15.
----------- destruct H16 as [H16 H17].
exact H10.
------ apply (@euclidean__tactics.Col__nCol__False (A) (B) (C) (H7) H9).
----- assert (* Cut *) (euclidean__axioms.nCol D E F) as H9.
------ exact H0.
...
--------- assert (* AndElim *) ((euclidean__axioms.Col D E F) /\ ((euclidean__axioms.Col D F E) /\ ((euclidean__axioms.Col F E D) /\ ((euclidean__axioms.Col E F D) /\ (euclidean__axioms.Col F D E))))) as H12.
---------- exact H11.
---------- destruct H12 as [H12 H13].
assert (* AndElim *) ((euclidean__axioms.Col D F E) /\ ((euclidean__axioms.Col F E D) /\ ((euclidean__axioms.Col E F D) /\ (euclidean__axioms.Col F D E)))) as H14.
----------- exact H13.
----------- destruct H14 as [H14 H15].
assert (* AndElim *) ((euclidean__axioms.Col F E D) /\ ((euclidean__axioms.Col E F D) /\ (euclidean__axioms.Col F D E))) as H16.
------------ exact H15.
------------ destruct H16 as [H16 H17].
assert (* AndElim *) ((euclidean__axioms.Col E F D) /\ (euclidean__axioms.Col F D E)) as H18.
------------- exact H17.
