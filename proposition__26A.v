...
--------- assert (exists G, (euclidean__axioms.BetS B G A) /\ (euclidean__axioms.Cong B G D E)) as H14 by exact H13.
...
---------- assert (exists G, (euclidean__axioms.BetS E G D) /\ (euclidean__axioms.Cong E G A B)) as H15 by exact H14.
...
--------------- assert (euclidean__axioms.nCol D E F) as H24 by exact H0.
...
---------- left.
exact H13.
---------- assert (euclidean__axioms.nCol D E F) as H15 by exact H0.
...
destruct H16 as [H20 H21].
destruct H19 as [H22 H23].
destruct H21 as [H24 H25].
destruct H23 as [H26 H27].
