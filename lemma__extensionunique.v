...
Definition lemma__extensionunique : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (E: euclidean__axioms.Point) (F: euclidean__axioms.Point), (euclidean__axioms.BetS A B E) -> ((euclidean__axioms.BetS A B F) -> ((euclidean__axioms.Cong B E B F) -> (E = F))).
Proof.
intro A.
intro B.
intro E.
...
---- assert (* Cut *) (euclidean__axioms.Cong B E B F) as H6.
----- exact H1.
