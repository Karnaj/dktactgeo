...
Definition proposition__05b : forall A B C F G, (euclidean__defs.isosceles A B C) -> ((euclidean__axioms.BetS A B F) -> ((euclidean__axioms.BetS A C G) -> (euclidean__defs.CongA C B F B C G))).
Proof.
intro A.
intro B.
intro C.
