...
Definition lemma__layoffunique : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (C: euclidean__axioms.Point) (D: euclidean__axioms.Point), (euclidean__defs.Out A B C) -> ((euclidean__defs.Out A B D) -> ((euclidean__axioms.Cong A C A D) -> (C = D))).
Proof.
intro A.
intro B.
intro C.
...
-------- assert (* Cut *) ((euclidean__axioms.BetS A C B) \/ ((B = C) \/ (euclidean__axioms.BetS A B C))) as H9.
--------- exact H3.
--------- assert (* Cut *) ((euclidean__axioms.BetS A C B) \/ ((B = C) \/ (euclidean__axioms.BetS A B C))) as __TmpHyp.
---------- exact H9.
---------- assert (euclidean__axioms.BetS A C B \/ (B = C) \/ (euclidean__axioms.BetS A B C)) as H10.
----------- exact __TmpHyp.
----------- destruct H10 as [H10|H10].
------------ assert (* Cut *) (C = D) as H11.
------------- assert (* Cut *) ((euclidean__axioms.BetS A D B) \/ ((B = D) \/ (euclidean__axioms.BetS A B D))) as H11.
-------------- exact H4.
-------------- assert (* Cut *) ((euclidean__axioms.BetS A D B) \/ ((B = D) \/ (euclidean__axioms.BetS A B D))) as __TmpHyp0.
--------------- exact H11.
--------------- assert (euclidean__axioms.BetS A D B \/ (B = D) \/ (euclidean__axioms.BetS A B D)) as H12.
---------------- exact __TmpHyp0.
...
-------------------- assert (* AndElim *) ((euclidean__axioms.Cong B C B D) /\ ((euclidean__axioms.Cong B C D B) /\ (euclidean__axioms.Cong C B B D))) as H15.
--------------------- exact H14.
--------------------- destruct H15 as [H15 H16].
assert (* AndElim *) ((euclidean__axioms.Cong B C D B) /\ (euclidean__axioms.Cong C B B D)) as H17.
---------------------- exact H16.
...
----------------- assert (B = D \/ euclidean__axioms.BetS A B D) as H13.
------------------ exact H12.
------------------ destruct H13 as [H13|H13].
------------------- assert (* Cut *) (euclidean__axioms.BetS A C D) as H14.
-------------------- apply (@eq__ind__r euclidean__axioms.Point D (fun B0: euclidean__axioms.Point => (euclidean__defs.Out A B0 C) -> ((euclidean__defs.Out A B0 D) -> ((euclidean__axioms.Cong A B0 A B0) -> ((euclidean__axioms.Cong B0 C B0 C) -> ((euclidean__axioms.Cong C B0 C B0) -> ((euclidean__axioms.BetS A C B0) -> (euclidean__axioms.BetS A C D)))))))) with (x := B).
---------------------intro H14.
intro H15.
intro H16.
intro H17.
...
----------------- assert (* Cut *) ((euclidean__axioms.BetS A D B) \/ ((B = D) \/ (euclidean__axioms.BetS A B D))) as H14.
------------------ exact H4.
------------------ assert (* Cut *) ((euclidean__axioms.BetS A D B) \/ ((B = D) \/ (euclidean__axioms.BetS A B D))) as __TmpHyp0.
------------------- exact H14.
------------------- assert (euclidean__axioms.BetS A D B \/ (B = D) \/ (euclidean__axioms.BetS A B D)) as H15.
-------------------- exact __TmpHyp0.
...
--------------------- assert (B = D \/ euclidean__axioms.BetS A B D) as H16.
---------------------- exact H15.
...
------------------------- apply (@eq__ind euclidean__axioms.Point B (fun C0: euclidean__axioms.Point => (euclidean__defs.Out A B C0) -> ((euclidean__axioms.Cong A C0 A D) -> ((euclidean__axioms.Cong A D A C0) -> ((euclidean__axioms.Cong B C0 B C0) -> ((euclidean__axioms.Cong C0 B C0 B) -> ((euclidean__axioms.Cong A C0 A C0) -> ((C0 = B) -> (D = B))))))))) with (y := C).
--------------------------intro H18.
intro H19.
intro H20.
intro H21.
...
-------------------------- apply (@eq__ind euclidean__axioms.Point B (fun D0: euclidean__axioms.Point => (euclidean__defs.Out A B D0) -> ((euclidean__axioms.Cong A C A D0) -> ((euclidean__axioms.Cong A D0 A C) -> ((euclidean__axioms.Cong A B A D0) -> ((euclidean__axioms.Cong A D0 A B) -> ((D0 = B) -> (C = D0)))))))) with (y := D).
---------------------------intro H19.
intro H20.
intro H21.
intro H22.
intro H23.
intro H24.
apply (@eq__ind euclidean__axioms.Point B (fun C0: euclidean__axioms.Point => (euclidean__defs.Out A B C0) -> ((euclidean__axioms.Cong A B A C0) -> ((euclidean__axioms.Cong A C0 A B) -> ((euclidean__axioms.Cong B C0 B C0) -> ((euclidean__axioms.Cong C0 B C0 B) -> ((euclidean__axioms.Cong A C0 A C0) -> ((C0 = B) -> ((B = B) -> (C0 = B)))))))))) with (y := C).
----------------------------intro H25.
intro H26.
intro H27.
intro H28.
...
--------------- assert (* Cut *) ((euclidean__axioms.BetS A D B) \/ ((B = D) \/ (euclidean__axioms.BetS A B D))) as H12.
---------------- exact H4.
---------------- assert (* Cut *) ((euclidean__axioms.BetS A D B) \/ ((B = D) \/ (euclidean__axioms.BetS A B D))) as __TmpHyp0.
----------------- exact H12.
----------------- assert (euclidean__axioms.BetS A D B \/ (B = D) \/ (euclidean__axioms.BetS A B D)) as H13.
------------------ exact __TmpHyp0.
------------------ destruct H13 as [H13|H13].
------------------- assert (* Cut *) (euclidean__axioms.BetS A D C) as H14.
-------------------- apply (@lemma__3__6b.lemma__3__6b (A) (D) (B) (C) (H13) H11).
-------------------- assert (* Cut *) (euclidean__axioms.Cong A D A C) as H15.
--------------------- exact H2.
--------------------- assert (* Cut *) (~(euclidean__axioms.neq C D)) as H16.
---------------------- intro H16.
...
------------------- assert (B = D \/ euclidean__axioms.BetS A B D) as H14.
-------------------- exact H13.
-------------------- destruct H14 as [H14|H14].
--------------------- assert (* Cut *) (euclidean__axioms.BetS A D C) as H15.
---------------------- apply (@eq__ind__r euclidean__axioms.Point D (fun B0: euclidean__axioms.Point => (euclidean__defs.Out A B0 C) -> ((euclidean__defs.Out A B0 D) -> ((euclidean__axioms.Cong A B0 A B0) -> ((euclidean__axioms.Cong B0 C B0 C) -> ((euclidean__axioms.Cong C B0 C B0) -> ((euclidean__axioms.BetS A B0 C) -> (euclidean__axioms.BetS A D C)))))))) with (x := B).
-----------------------intro H15.
intro H16.
intro H17.
intro H18.
...
----------------------- assert (* AndElim *) ((euclidean__axioms.neq B D) /\ ((euclidean__axioms.neq A B) /\ (euclidean__axioms.neq A D))) as H16.
------------------------ exact H15.
------------------------ destruct H16 as [H16 H17].
assert (* AndElim *) ((euclidean__axioms.neq A B) /\ (euclidean__axioms.neq A D)) as H18.
------------------------- exact H17.
