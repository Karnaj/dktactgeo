...
Definition lemma__altitudebisectsbase : forall (A: euclidean__axioms.Point) (B: euclidean__axioms.Point) (M: euclidean__axioms.Point) (P: euclidean__axioms.Point), (euclidean__axioms.BetS A M B) -> ((euclidean__axioms.Cong A P B P) -> ((euclidean__defs.Per A M P) -> (euclidean__defs.Midpoint A M B))).
Proof.
intro A.
intro B.
intro M.
...
intro H0.
intro H1.
assert (* Cut *) (exists (C: euclidean__axioms.Point), (euclidean__axioms.BetS A M C) /\ ((euclidean__axioms.Cong A M C M) /\ ((euclidean__axioms.Cong A P C P) /\ (euclidean__axioms.neq M P)))) as H2.
- exact H1.
- assert (exists C: euclidean__axioms.Point, ((euclidean__axioms.BetS A M C) /\ ((euclidean__axioms.Cong A M C M) /\ ((euclidean__axioms.Cong A P C P) /\ (euclidean__axioms.neq M P))))) as H3.
-- exact H2.
-- destruct H3 as [C H3].
assert (* AndElim *) ((euclidean__axioms.BetS A M C) /\ ((euclidean__axioms.Cong A M C M) /\ ((euclidean__axioms.Cong A P C P) /\ (euclidean__axioms.neq M P)))) as H4.
--- exact H3.
--- destruct H4 as [H4 H5].
assert (* AndElim *) ((euclidean__axioms.Cong A M C M) /\ ((euclidean__axioms.Cong A P C P) /\ (euclidean__axioms.neq M P))) as H6.
---- exact H5.
---- destruct H6 as [H6 H7].
assert (* AndElim *) ((euclidean__axioms.Cong A P C P) /\ (euclidean__axioms.neq M P)) as H8.
----- exact H7.
...
---------- assert (* Cut *) (exists (Q: euclidean__axioms.Point), (euclidean__axioms.BetS P M Q) /\ ((euclidean__axioms.Cong P M Q M) /\ ((euclidean__axioms.Cong P A Q A) /\ (euclidean__axioms.neq M A)))) as H15.
----------- exact H14.
----------- assert (exists Q: euclidean__axioms.Point, ((euclidean__axioms.BetS P M Q) /\ ((euclidean__axioms.Cong P M Q M) /\ ((euclidean__axioms.Cong P A Q A) /\ (euclidean__axioms.neq M A))))) as H16.
------------ exact H15.
------------ destruct H16 as [Q H16].
assert (* AndElim *) ((euclidean__axioms.BetS P M Q) /\ ((euclidean__axioms.Cong P M Q M) /\ ((euclidean__axioms.Cong P A Q A) /\ (euclidean__axioms.neq M A)))) as H17.
------------- exact H16.
------------- destruct H17 as [H17 H18].
assert (* AndElim *) ((euclidean__axioms.Cong P M Q M) /\ ((euclidean__axioms.Cong P A Q A) /\ (euclidean__axioms.neq M A))) as H19.
-------------- exact H18.
-------------- destruct H19 as [H19 H20].
assert (* AndElim *) ((euclidean__axioms.Cong P A Q A) /\ (euclidean__axioms.neq M A)) as H21.
--------------- exact H20.
...
------------------- assert (* Cut *) (exists (E: euclidean__axioms.Point), (euclidean__axioms.BetS P M E) /\ ((euclidean__axioms.Cong P M E M) /\ ((euclidean__axioms.Cong P B E B) /\ (euclidean__axioms.neq M B)))) as H27.
-------------------- exact H26.
-------------------- assert (exists E: euclidean__axioms.Point, ((euclidean__axioms.BetS P M E) /\ ((euclidean__axioms.Cong P M E M) /\ ((euclidean__axioms.Cong P B E B) /\ (euclidean__axioms.neq M B))))) as H28.
--------------------- exact H27.
--------------------- destruct H28 as [E H28].
assert (* AndElim *) ((euclidean__axioms.BetS P M E) /\ ((euclidean__axioms.Cong P M E M) /\ ((euclidean__axioms.Cong P B E B) /\ (euclidean__axioms.neq M B)))) as H29.
---------------------- exact H28.
---------------------- destruct H29 as [H29 H30].
assert (* AndElim *) ((euclidean__axioms.Cong P M E M) /\ ((euclidean__axioms.Cong P B E B) /\ (euclidean__axioms.neq M B))) as H31.
----------------------- exact H30.
----------------------- destruct H31 as [H31 H32].
assert (* AndElim *) ((euclidean__axioms.Cong P B E B) /\ (euclidean__axioms.neq M B)) as H33.
------------------------ exact H32.
...
-------------------------- assert (* AndElim *) ((euclidean__axioms.Cong P A P B) /\ ((euclidean__axioms.Cong P A B P) /\ (euclidean__axioms.Cong A P P B))) as H36.
--------------------------- exact H35.
--------------------------- destruct H36 as [H36 H37].
assert (* AndElim *) ((euclidean__axioms.Cong P A B P) /\ (euclidean__axioms.Cong A P P B)) as H38.
---------------------------- exact H37.
...
--------------------------- assert (* AndElim *) ((euclidean__axioms.Cong M Q M P) /\ ((euclidean__axioms.Cong M Q P M) /\ (euclidean__axioms.Cong Q M M P))) as H37.
---------------------------- exact H36.
---------------------------- destruct H37 as [H37 H38].
assert (* AndElim *) ((euclidean__axioms.Cong M Q P M) /\ (euclidean__axioms.Cong Q M M P)) as H39.
----------------------------- exact H38.
...
------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong M E Q M) /\ ((euclidean__axioms.Cong M E M Q) /\ (euclidean__axioms.Cong E M Q M))) as H41.
-------------------------------- exact H40.
-------------------------------- destruct H41 as [H41 H42].
assert (* AndElim *) ((euclidean__axioms.Cong M E M Q) /\ (euclidean__axioms.Cong E M Q M)) as H43.
--------------------------------- exact H42.
...
--------------------------------- assert (* AndElim *) ((euclidean__axioms.neq M E) /\ ((euclidean__axioms.neq P M) /\ (euclidean__axioms.neq P E))) as H43.
---------------------------------- exact H42.
---------------------------------- destruct H43 as [H43 H44].
assert (* AndElim *) ((euclidean__axioms.neq P M) /\ (euclidean__axioms.neq P E)) as H45.
----------------------------------- exact H44.
...
------------------------------------ assert (* AndElim *) ((euclidean__axioms.Cong A P B P) /\ ((euclidean__axioms.Cong A P P B) /\ (euclidean__axioms.Cong P A B P))) as H46.
------------------------------------- exact H45.
------------------------------------- destruct H46 as [H46 H47].
assert (* AndElim *) ((euclidean__axioms.Cong A P P B) /\ (euclidean__axioms.Cong P A B P)) as H48.
-------------------------------------- exact H47.
...
-------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong A Q A P) /\ (euclidean__axioms.Cong A P A Q)) as H48.
--------------------------------------- exact H47.
--------------------------------------- destruct H48 as [H48 H49].
exact H48.
...
---------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong Q A B Q) /\ ((euclidean__axioms.Cong Q A Q B) /\ (euclidean__axioms.Cong A Q B Q))) as H50.
----------------------------------------- exact H49.
----------------------------------------- destruct H50 as [H50 H51].
assert (* AndElim *) ((euclidean__axioms.Cong Q A Q B) /\ (euclidean__axioms.Cong A Q B Q)) as H52.
------------------------------------------ exact H51.
...
---------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Col P A M) /\ ((euclidean__axioms.Col P M A) /\ ((euclidean__axioms.Col M A P) /\ ((euclidean__axioms.Col A M P) /\ (euclidean__axioms.Col M P A))))) as H56.
----------------------------------------------- exact H55.
----------------------------------------------- destruct H56 as [H56 H57].
assert (* AndElim *) ((euclidean__axioms.Col P M A) /\ ((euclidean__axioms.Col M A P) /\ ((euclidean__axioms.Col A M P) /\ (euclidean__axioms.Col M P A)))) as H58.
------------------------------------------------ exact H57.
------------------------------------------------ destruct H58 as [H58 H59].
assert (* AndElim *) ((euclidean__axioms.Col M A P) /\ ((euclidean__axioms.Col A M P) /\ (euclidean__axioms.Col M P A))) as H60.
------------------------------------------------- exact H59.
------------------------------------------------- destruct H60 as [H60 H61].
assert (* AndElim *) ((euclidean__axioms.Col A M P) /\ (euclidean__axioms.Col M P A)) as H62.
-------------------------------------------------- exact H61.
...
------------------------------------------------------ assert (* AndElim *) ((euclidean__axioms.Cong A M B M) /\ ((euclidean__defs.CongA P A M P B M) /\ (euclidean__defs.CongA P M A P M B))) as H64.
------------------------------------------------------- exact H63.
------------------------------------------------------- destruct H64 as [H64 H65].
assert (* AndElim *) ((euclidean__defs.CongA P A M P B M) /\ (euclidean__defs.CongA P M A P M B)) as H66.
-------------------------------------------------------- exact H65.
...
--------------------------------------------------------- assert (* AndElim *) ((euclidean__axioms.Cong M A M B) /\ ((euclidean__axioms.Cong M A B M) /\ (euclidean__axioms.Cong A M M B))) as H69.
---------------------------------------------------------- exact H68.
---------------------------------------------------------- destruct H69 as [H69 H70].
assert (* AndElim *) ((euclidean__axioms.Cong M A B M) /\ (euclidean__axioms.Cong A M M B)) as H71.
----------------------------------------------------------- exact H70.
