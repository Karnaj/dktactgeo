...
Definition proposition__15 : forall A B C D E, (euclidean__axioms.BetS A E B) -> ((euclidean__axioms.BetS C E D) -> ((euclidean__axioms.nCol A E C) -> ((euclidean__defs.CongA A E C D E B) /\ (euclidean__defs.CongA C E B A E D)))).
Proof.
intro A.
intro B.
intro C.
...
--------------------------- exact H26.
--------------------------- exact H12.
-------------------------- assert (euclidean__axioms.BetS C E D) as H28 by exact H0.
...
---------------------------- assert (euclidean__defs.CongA B E C C E B) as H31 by exact H20.
...
exact H38.
---------------------------------- apply (@H6 H33).
------------------------------ assert (euclidean__defs.CongA B E D D E B) as H34 by exact H17.
...
---------------------------------- exact H24.
Qed.
Definition proposition__15a : forall A B C D E, (euclidean__axioms.BetS A E B) -> ((euclidean__axioms.BetS C E D) -> ((euclidean__axioms.nCol A E C) -> (euclidean__defs.CongA A E C D E B))).
Proof.
intro A.
intro B.
intro C.
...
- apply (@H2 H H0 H1).
Qed.
Definition proposition__15b : forall A B C D E, (euclidean__axioms.BetS A E B) -> ((euclidean__axioms.BetS C E D) -> ((euclidean__axioms.nCol A E C) -> (euclidean__defs.CongA C E B A E D))).
Proof.
intro A.
intro B.
intro C.
